                                        ...
                                        <tr>
                                            ...
                                            <td class="action-center">
                                                <div class="text-center">
                                                    ...
                                                    <?php  if(!empty(Session::get('acl')[10][3])){ ?>
                                                        <a class='btn btn-info btn-xs' href="{!! URL::to('reg_nsd/registred_nsd_name/acttive/' . $nn->id ) !!}" data-rel="tooltip" title="@if($nn->default_selected == '1') Unselected  @else Selected @endif" data-placement="top">
                                                            @if($nn->default_selected == '1')
