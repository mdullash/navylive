        ...
        <div class="row">
            <div class="col-sm-6 col-md-12">
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        {{ Form::model($editId, array('route' => array('registred_nsd_name.update', $editId->id), 'method' => 'PUT', 'files'=> true, 'class' => 'form form-horizontal validate-form registred_nsd_name', 'id' => 'registred_nsd_name')) }}
                        ...
                        <div class="form-group"><label class="control-label col-md-4 no-padding-right" for="stall_id">External Link :</label>
                            <div class="col-md-5">
                                {!!  Form::text('external_link', old('external_link'), array('id'=> 'external_link', 'class' => 'form-control')) !!}
                            </div>
                        </div>
