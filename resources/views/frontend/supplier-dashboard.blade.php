                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                        ...
                                        <div class="" style="text-align: center;background-color: #fff;padding: 10px;">
                                            ...
                                            @if (Auth::guard('supplier')->check())
                                                ...
                                                <h3>{!! Auth::guard('supplier')->user()->company_name !!}</h3>
                                                <p>{!! Auth::guard('supplier')->user()->email !!}</p>
                                                <p>
                                                 <?php
                                                            ...
                                                            <div class="card-body text-center">
                                                              <h4 class="card-text text-white">Tender Participation</h4>
                                                               <h1 class="card-text text-white" style="font-size: 40px;">
                                                                    {{ 
                                                                        !empty($SupplierTenderAttendCount) ?
                                                        ...
                                                        <div class="card bg-info">
                                                            <div class="card-body text-center">
                                                              <h4 class="card-text text-white"></h4>
                                                               <h1 class="card-text text-white" style="font-size: 40px;"></h1>
                                                            </div>
                                                        </div>
                                                    </div> --}}
