                ...
                <div class="hpanel">
                    <div class="panel-heading hbuilt">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-info btn-effect-ripple" href="{{ URL::to('zone/create') }}"><i class="fa fa-plus"></i> Add Zone</a>
                        </div>
                        <?php } ?>
                            <h3>Zone</h3>
                    </div>
                        <div class="panel-body">
                            <table class="table table-bordered table-hover table-striped middle-align">
                                ...
                                <tr class="center">
                                    ...
                                    <?php if(!empty(Session::get('acl')[21][3]) || !empty(Session::get('acl')[21][4])){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="action-center">
                                                <div class="text-center">
                                                    ...
                                                    <?php if(!empty(Session::get('acl')[21][3])){ ?>
                                                    <a class="btn btn-primary btn-xs" href="{{ URL::to('zone/edit/' . $zns->id ) }}">
                                                        <i class="icon-edit"></i>
                                                    </a>
                                                    <?php } ?>

                                                    <?php if(!empty(Session::get('acl')[21][4])){?>
