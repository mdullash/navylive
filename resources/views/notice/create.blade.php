        ...
        <div class="row">
            <div class="col-sm-6 col-md-12">
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        {{ Form::open(array('role' => 'form', 'url' => 'notice/store', 'files'=> true, 'class' => 'form-horizontal notice', 'id'=>'notice')) }}
                        ...
                        <div class="form-group"><label class="control-label col-md-4 no-padding-right" for="status"></label>
                            <div class="col-md-5">
                                ...
                                <div class="checkbox checkbox-success">
                                    <input class="activity_1 activitycell" type="checkbox" id="open_tender" name="is_important" value="1">
                                    <label for="open_tender">Flash                                                                                                                                                                                                    </label>
                                </div>

                                <div class="checkbox checkbox-success">
                                    <input class="activity_1 activitycell" type="checkbox" id="is_flash" name="is_general" value="1">
                                    <label for="is_flash">General                                                                                                                                                                                                   </label>
                                </div>
