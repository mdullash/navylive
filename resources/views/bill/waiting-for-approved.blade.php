                                ...
                                @if (!$demands->isEmpty())
                                    ...
                                    @foreach($demands as $sc)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if(!empty(Session::get('acl')[55][12]))
                                                <a href="{{url('/bill/approve-create/'.$sc->billId)}}" class="btn btn-xs btn-success">
                                                    <i class="icon-check"></i>
                                                </a>
                                                @endif

                                                @if(!empty(Session::get('acl')[55][9]))
                                                <a href="{{url('/bill/print/'.$sc->billId)}}" class="btn btn-xs btn-primary" target="_blank">
