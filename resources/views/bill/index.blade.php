                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <ul class="nav nav-tabs">
                                    <?php if(!empty(Session::get('acl')[34][35]) && $demandDetailPageFromRoute=='bill'){ ?>
                                        <li @if($demandDetailPageFromRoute=='bill' && $segTwo==1)class="active" @endif><a href="{{URL::to('bill/1')}}"> Pending</a></li>
                                    <?php } ?>
                                    <?php if(!empty(Session::get('acl')[34][36]) && $demandDetailPageFromRoute=='bill'){ ?>
                                    <li @if($demandDetailPageFromRoute=='bill' && $segTwo==2)class="active" @endif><a href="{{URL::to('bill/2')}}"> Waiting for approve</a></li>
                                    <?php } ?>
                                    <li @if($demandDetailPageFromRoute=='bill' && $segTwo==3)class="active" @endif><a href="{{URL::to('bill/3')}}"> Approved</a></li>
                                </ul>
