                ...
                <div class="hpanel">
                    <div class="panel-heading hbuilt">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-info btn-effect-ripple" href="{{ URL::to('deno/create') }}"><i class="fa fa-plus"></i> Add Denotation</a>
                        </div>
                        <?php } ?>
                            <h3>Denotation</h3>
                    </div>
                        <div class="panel-body">
                            <table class="table table-bordered table-hover table-striped middle-align">
                                ...
                                <tr class="center">
                                    ...
                                    <th class="text-center">{{'Denotation Name'}}</th>
                                    <th class="text-center" width="">{{'Description'}}</th>
                                    <th class="text-center">{{trans('english.STATUS')}}</th>
                                    <?php if(!empty(Session::get('acl')[15][3]) || !empty(Session::get('acl')[15][4])){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="action-center">
                                                <div class="text-center">
                                                    ...
                                                    <?php if(!empty(Session::get('acl')[15][3])){ ?>
                                                    <a class="btn btn-primary btn-xs" href="{{ URL::to('deno/edit/' . $sc->id ) }}">
                                                        <i class="icon-edit"></i>
                                                    </a>
                                                    <?php } ?>

                                                    <?php if(!empty(Session::get('acl')[15][4])){?>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $(".exbtovdelete").click(function (e) {
                ...
                var id = this.id; 
                var url='{!! URL::to('deno/destroy') !!}'+'/'+id;
