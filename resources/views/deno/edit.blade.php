        ...
        <div class="row">
            <div class="col-sm-6 col-md-12">
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        {{ Form::model($editId, array('route' => array('deno.update', $editId->id), 'method' => 'PUT', 'files'=> true, 'class' => 'form form-horizontal validate-form denos', 'id' => 'denos')) }}

                        <div class="form-group"><label class="control-label col-md-4 no-padding-right" for="stall_id">Denotation :<span class="text-danger">*</span></label>
                            <div class="col-md-5">
