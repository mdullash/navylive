        ...
        <ul class="nav" id="side-menu">
            ...
            <li <?php $current = ($currentControllerName == 'suppliers') ||  ($currentControllerName1 == 'enlistment') ||($currentControllerName1 == 'dni-npm-approval') ||  ($currentControllerName1 == 'sells-form')||  ($currentControllerName1 == 'waiting-for-clarence') ||  ($currentControllerName1 == 'dni') ||  ($currentControllerName1 == 'npm') ? 'active' : ''; ?> class="<?php echo $current; ?>">
                ...
                <ul class="nav nav-second-level">
                        ...
                        <li <?php $current = ($currentControllerName1 == 'waiting-for-clarence') ? 'active' : ''; ?> class="<?php echo $current; ?>"><a href="{{URL::to('suppliers/waiting-for-clarence/index/pending')}}">Waiting for clarence</a></li>
                        <?php }   ?>


                        <?php if (!empty($aclList[49][1])) { ?>
                        <li <?php $current = ($currentControllerName1 == 'dni') ? 'active' : ''; ?> class="<?php echo $current; ?>"><a href="{{URL::to('suppliers/dni/index/pending')}}">DNI</a></li>
                        <?php }   ?>

                        <?php if (!empty($aclList[50][1])) { ?>
                        <li <?php $current = ($currentControllerName1 == 'npm') ? 'active' : ''; ?> class="<?php echo $current; ?>"><a href="{{URL::to('suppliers/npm/index/pending')}}">NPM</a></li>
                        <?php }   ?>


                        <?php if (!empty($aclList[51][1])) { ?>
                        <li <?php $current = ($currentControllerName1 == 'dni-npm-approval') ? 'active' : ''; ?> class="<?php echo $current; ?>"><a href="{{URL::to('suppliers/dni-npm-approval')}}">DNS Approval</a></li>
                        <?php }   ?>

                        <?php if (!empty($aclList[56][1])) { ?>
                        <li <?php $current = ($currentControllerName1 == 'supplier-approval') ? 'active' : ''; ?> class="<?php echo $current; ?>"><a href="{{URL::to('suppliers/supplier-approval')}}"> Supplier Approval</a></li>
                        <?php }   ?>
