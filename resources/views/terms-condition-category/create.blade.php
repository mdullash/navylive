        ...
        <div class="hpanel">
            <div class="panel-body">
                <h2 class="font-light m-b-xs">
                    Create Terms and Condition Category
                </h2>
            </div>
        ...
        <div class="row">
            <div class="col-sm-6 col-md-12">
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        {{ Form::open(array('role' => 'form', 'url' => 'terms-conditions-category', 'files'=> true, 'class' => 'form-horizontal supplierCategory', 'id'=>'supplierCategory')) }}
