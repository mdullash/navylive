        ...
        <div class="hpanel">
            <div class="panel-body">
                <h2 class="font-light m-b-xs">
                    Update Terms and Condition Category
                </h2>
            </div>
        ...
        <div class="row">
            <div class="col-sm-6 col-md-12">
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        {{ Form::model($editId, array('route' => array('terms-conditions-category.update', $editId->id), 'method' => 'PUT', 'files'=> true, 'class' => 'form form-horizontal validate-form supplierCategory', 'id' => 'supplierCategory')) }}
