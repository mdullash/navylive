...
<table style="border: 0;">
    ...
    <tr>
        <td style="text-align: center;border: 0">@if($issue_datas['issuedName']->digital_sign !=null)<img src="{!! asset('public/uploads/digital_sign/'.$issue_datas['issuedName']->digital_sign) !!}" alt="">@endif</td>
        <td style="text-align: center;border: 0"> </td>
        <td style="text-align: center;border: 0"> @if($issue_datas['approvedName']->digital_sign !=null) <img src="{!! asset('public/uploads/digital_sign/'.$issue_datas['approvedName']->digital_sign) !!}" alt="">@endif</td>
    </tr>
    <tr>
