                                ...
                                <div class="col-md-12 remove appendRewRow firstRow" id="firstRow" {{--style="border: 1px solid black; padding: 5px;"--}}>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control imc_number" id="serial_or_reg_number" name="serial_or_reg_number[]" value="{!! $itd->serial_imc_no !!}" placeholder="Serial / Registration">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control conversion" id="currency_rates" name="currency_rates[]" value="{!! $itd->currency_rate !!}" placeholder="Currency Rates" min="1">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control unit_price" id="price" name="price[]" value="{!! $itd->unit_price !!}" placeholder="Price" min="0" required>
                                        </div>
                                    </div>
