            ...
            <div class="col-sm-6 col-md-12">
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        ...
                        {{ Form::open(array('role' => 'form', 'url' => 'demand', 'files'=> true, 'class' => '', 'id'=>'demands')) }}
                            ...
                            <div class="col-md-12" {{--style="border: 1px solid black; padding: 5px;"--}}>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="demand_no">4. Demand No:<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control " id="demand_no" name="demand_no" placeholder="Demand no">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="priority">5. Priority:<span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="when_needed">6. When Needed</label>
                                        <input type="text" class="form-control datapicker2" id="when_needed" name="when_needed" placeholder="When Needed" value="{!! date('Y-m-d') !!}" readonly>
                                    </div>
                                </div>

                                <div class="col-md-4 sItemType">
                                    <div class="form-group">
                                        <label for="permanent_or_waste_content1">7. Item Type</label>
                                        <div class="radio radio-info">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="place_to_send">9. Destination Place</label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="for_whom">10. For Whom</label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="pattern_or_stock_no">11. Patt/Part Number:<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="pattern_or_stock_no" name="pattern_or_stock_no" placeholder="Pattern Stock No" required="">
                                    </div>
                                </div>

                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="pattern_or_stock_no">12. Item Details:<span class="text-danger">*</span></label>
                                        <textarea class="form-control" id="product_detailsetc" name="product_detailsetc" placeholder="Item Details" rows="3" required=""></textarea>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12 remove appendRewRow firstRow" id="firstRow" {{--style="border: 1px solid black; padding: 5px;"--}}>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="serial_or_reg_number">Serial/Registration/IMC No:<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control imc_number" id="serial_or_reg_number" name="serial_or_reg_number[]" placeholder="Serial/Registration/IMC No">
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control conversion" id="currency_rates" name="currency_rates[]" placeholder="Currency Rate" min="1">
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control unit_price" id="price" name="price[]" placeholder="Price" min="0" required>
                                </div>
                            </div>
