                    ...
                    <div class="panel-heading hbuilt">
                                            ...
                                            <td colspan="3">
                                                @if(empty($demand->group_status))
                                                    ...
                                                    @elseif($demand->group_status == 2 && empty($demand->tender_floating))
                                                        ...
                                                        @if(!empty($demand->transfer_to) && $demand->plr_status==2 )
                                                            <span class=" btn-warning btn-xs">Canceled By {!! $demand->transferOrgName->name !!}</span>
                                                        @endif

                                                         @if(!empty($demand->transfer_to) && empty($demand->transfer_status) )
                                                            <span class=" btn-warning btn-xs">Waiting for {!! $demand->transferOrgName->name."'s response" !!}</span>

                                                            @elseif(!empty($demand->transfer_to) && $demand->transfer_status==2 && $demand->plr_status==1)
                                                            <span class=" btn-warning btn-xs">Hold By {!! $demand->transferOrgName->name !!}</span>

                                                            @elseif(!empty($demand->transfer_to) && $demand->transfer_status==2 && $demand->plr_status==3)
                                                    ...
                                                    @elseif( !empty($demand->lp_section_status) && $demand->lp_section_status ==2 && $demand->head_ofc_apvl_status == 2 )
                                                        <span class=" btn-warning btn-xs"> {!! "Waiting for HQ Approval" !!}</span>

                                                    @elseif(!empty($demand->cst_supplier_select) && $demand->lp_section_status==1 && empty($demand->po_status) && ($demand->head_ofc_apvl_status==1 || $demand->head_ofc_apvl_status=='')  )
                                                    <span class=" btn-warning btn-xs"> {!! "Generate PO" !!}</span>

                                                    @elseif(!empty($demand->po_status) && empty($demand->cr_status))
                                                    <span class=" btn-warning btn-xs"> {!! "In CR section" !!}</span>

                                                    @elseif(!empty($demand->cr_status) && empty($demand->inspection_status))
                                                    <span class=" btn-warning btn-xs"> {!! "Waiting for inspection" !!}</span>

                                                    @elseif(!empty($demand->inspection_status) && empty($demand->final_status))
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <a class="btn btn-primary btn-xs" href="{{ URL::to('v44voucher-pdf-view/'.$demand->id) }}" title="V44voucher" target="_blank">
                                                        <i class="icon-eye-open"> V44 voucher</i>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <?php if(!empty(Session::get('acl')[34][21]) && !empty($demand->lp_section_status) && $demand->lp_section_status ==2 && $demand->head_ofc_apvl_status == 2 ){ ?>
                                ...
                                <?php if(!empty(Session::get('acl')[34][22]) && !empty($demand->cst_supplier_select) && $demand->lp_section_status==1 && ($demand->head_ofc_apvl_status==1 || $demand->head_ofc_apvl_status=='')  ){ ?>
                                ...
                                <?php if(!empty(Session::get('acl')[34][23]) && !empty($demand->lp_section_status) && $demand->po_status==1 ){ ?>
                                    <a class="btn btn-primary btn-xs" href="{{ URL::to('cr-section/'.$demand->id) }}" title="CST view" target="_blank">
                                        <i class="icon-eye-open"> CR</i>
                                    </a>
                                <?php } ?>

                                <?php if(!empty(Session::get('acl')[34][24]) && !empty($demand->po_status) && $demand->cr_status==1 ){ ?>
                                    <a class="btn btn-primary btn-xs" href="{{ URL::to('inspection-section/'.$demand->id) }}" title="CST view">
