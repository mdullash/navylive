                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <ul class="nav nav-tabs">
                                    ...
                                    <li @if($demandDetailPageFromRoute=='inspection-view-acc' && $segTwo==2)class="active" @endif><a href="{{URL::to('inspection-view-acc/2')}}"> Inspected</a></li>
                                </ul>
                                ...
                                @if (!$demands->isEmpty())
                                    ...
                                    @foreach($demands as $sc)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-success btn-xs" href="{{ URL::to('inspection-section/'.$sc->id.'&'.$sc->tender_id.'&'.$segTwo) }}" title="Inspection view">
                                                    @if($segTwo == 1)
