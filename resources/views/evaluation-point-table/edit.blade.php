        ...
        <div class="row">
            <div class="col-sm-6 col-md-12">
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        {{ Form::model($evlpotbl, array('route' => array('evaluation-point.update', $evlpotbl->id), 'method' => 'PUT', 'files'=> true, 'class' => 'form form-horizontal validate-form contact', 'id' => 'contact')) }}
                        ...
                        <div class="form-group"><label class="control-label col-md-3 no-padding-right" for="title">Lower Point Limit :<span class="text-danger">*</span></label>
                            <div class="col-md-6">
                                {!!  Form::text('lower_point_limit', old('lower_point_limit'), array('id'=> 'lower_point_limit', 'class' => 'form-control', 'required' => 'true')) !!}
                            </div>
                        </div>

                        <div class="form-group"><label class="control-label col-md-3 no-padding-right" for="title">Upper Point Limit :<span class="text-danger">*</span></label>
                            <div class="col-md-6">
                                {!!  Form::text('higher_point_limit', old('higher_point_limit'), array('id'=> 'higher_point_limit', 'class' => 'form-control', 'required' => 'true')) !!}
                            </div>
                        </div>
