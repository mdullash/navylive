                                            ...
                                            <tr>
                                                ...
                                                <?php $devideData2 = explode('?',$swca); ?>
                                                    <td colspan="@if(empty($devideData2[2])) 6 @else 12 @endif">
                                                        ...
                                                        <textarea class="form-control" name="comment[{!! $devideData2[1] !!}]" rows="1" placeholder="Comment">{!! $devideData2[0] !!}</textarea>
                                                    </td>
                                                @endforeach
                                            </tr>
                                            @endif  
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control selectpicker" name="send_to_nhq" id="send_to_nhq" required="">
                                                ...
                                                <option value="1" @if($tender->send_to_nhq==1) selected @endif >{!! 'Send To Final CST' !!}</option>
                                                <option value="2" @if($tender->send_to_nhq==2) selected @endif>{!! 'Need NHQ Approval' !!}</option>
                                            </select>
                                        </div>
                                    </div>
