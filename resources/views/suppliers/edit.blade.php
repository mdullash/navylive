        ...
        <div class="row">
            <div class="col-sm-6 col-md-12">
                <div class="hpanel">
                    ...
                    {{ Form::model($editId, array('route' => array('suppliers.update', $editId->id), 'method' => 'PUT', 'files'=> true, 'class' => 'form form-horizontal validate-form suppliers', 'id' => 'suppliers')) }}
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-6">
                            ...
                            <div class="form-group"><label class="control-label col-md-5 no-padding-right" for="status">Supply Category :<span class="text-danger">*</span></label>
                                <div class="col-md-7">
                                    <?php $selectedCat = explode(',',$editId->supply_cat_id); ?>
                                    <select class="form-control selectpicker" name="supply_cat_id[]" id="supply_cat_id"  data-live-search="true" multiple="">
                                        ...
                                        @foreach($supplyCategories as $sc)
                                            <option value="{!! $sc->id !!}" @foreach($selectedCat as $ssc) @if( $sc->id==$ssc) {!! 'selected' !!} @endif @endforeach>{!! $sc->name !!}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group"><label class="control-label col-md-5 no-padding-right" for="stall_id">Organization :<span class="text-danger">*</span></label>
                                <div class="col-md-7">
                                    <?php $selectedNsd = explode(',',$editId->registered_nsd_id); ?>
                    ...
                    <?php
                        $supplierInfos = \App\SupplierMultiInfo::where('supplier_id','=',$editId->id)->get();
	                    $supplierInfos_count = count($supplierInfos);
                        ?>
                       @if($supplierInfos_count > 0)
                            @foreach($supplierInfos as $supplierInfo)
                                <div class="col-md-12 remove appendRewRow firstRow" id="firstRow">

                                <span><b></b></span><br>

                                <input type="hidden" name="supplier_info_id1[]" value="{{$supplierInfo->id}}">

                                <div class="col-md-3" style="padding-right: 25px;">
                                    <div class="form-group">
                                        <label for="name">Name:<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control unit" id="name" name="name[]" placeholder="Name" required value="{{$supplierInfo->name}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3" style="padding-right: 25px;">
                                    <div class="form-group">
                                        ...
                                        <input type="designation" class="form-control unit" id="designation" name="designation[]" placeholder="Designation" required value="{{$supplierInfo->designation}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3" style="padding-right: 25px;">
                                    <div class="form-group">
                                        ...
                                        <input type="mobile_number" class="form-control unit" id="mobile_number" name="mobile_number1[]" placeholder="Mobile Number" required value="{{$supplierInfo->mobile_number1}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="barcode_number" class="form-control unit" id="barcode_number" name="barcode_number1[]" placeholder="Barcode Number" required value="{{$supplierInfo->barcode_number}}">
                                    </div>
                                </div>
                                <div class="col-md-1" style="margin-top: 25px;">
                                    <a href="{{url('/suppliers/suppliers-multiinfo/delete/'.$supplierInfo->id)}}" class="btn btn-danger" id=""><i class="fa fa-trash"></i></a>
                                </div>
                           ...
                           @else
                           <?php
		                    $supplierInfos_count = $supplierInfos_count+1;
                            ?>
                               <div class="col-md-12 remove appendRewRow firstRow" id="firstRow">

                                   <span><b></b></span><br>

                                   <input type="hidden" name="supplier_info_id1[]" value="">

                                   <div class="col-md-3" style="padding-right: 25px;">
                                       <div class="form-group">
                                           <label for="name">Name:<span class="text-danger">*</span></label>
                                           <input type="text" class="form-control unit" id="name" name="name[]" placeholder="Name" required value="">
                                       </div>
                                   </div>
                                   ...
                                   <div class="col-md-3" style="padding-right: 25px;">
                                       <div class="form-group">
                                           <label for="designation">Designation:<span class="text-danger">*</span></label>
                                           <input type="designation" class="form-control unit" id="designation" name="designation[]" placeholder="Designation" required value="">
                                       </div>
                                   </div>
                                   ...
                                   <div class="col-md-3" style="padding-right: 25px;">
                                       <div class="form-group">
                                           <label for="mobile_number">Mobile Number:<span class="text-danger">*</span></label>
                                           <input type="mobile_number" class="form-control unit" id="mobile_number" name="mobile_number1[]" placeholder="Mobile Number" required value="">
                                       </div>
                                   </div>
                                   ...
                                   <div class="col-md-3">
                                       <div class="form-group">
                                           <label for="barcode_number">Barcode Number:<span class="text-danger">*</span></label>
                                           <input type="barcode_number" class="form-control unit" id="barcode_number" name="barcode_number1[]" placeholder="Barcode Number" required value="">
                                       </div>
                                   </div>
                                   {{--<div class="col-md-1" style="margin-top: 25px;">--}}
                                       {{--<a href="{{url('/suppliers/suppliers-multiinfo/delete/'.$supplierInfo->id)}}" class="btn btn-danger" id=""><i class="fa fa-trash"></i></a>--}}
