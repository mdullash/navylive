            ...
            <div class="col-sm-6 col-md-12">
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        ...
                        @if(Request::segment(4)=='supplier-info-approval')
                        {{ Form::model($editId, array('route' => array('supplierInfo-approval.update', $editId->id), 'method' => 'PUT', 'files'=> true, 'class' => 'form form-horizontal validate-form supplier_info_tab', 'id' => 'suppliers')) }}
                         @else
                        {{ Form::model($editId, array('route' => array('supplierInfo.update', $editId->id), 'method' => 'PUT', 'files'=> true, 'class' => 'form form-horizontal validate-form supplier_info_tab', 'id' => 'suppliers')) }}
                        @endif
                        ...
                        <!-- Nav tabs -->
                            ...
                            <div class="col-md-12">
                                ...
                                <?php if(!empty(Session::get('acl')[46][12])){ ?>


                            @if(Request::segment(4)=='supplier-info-approval')
                                    <a class="btn btn-info  approve pull-left" id="{{$editId->id}}" href="{{ URL::to('suppliers/enlistment/approved/' . $editId->id ) }}" title="Approve" onclick="return confirm('Are you Sure?')">
                                ...
                                @endif
                                 ...
                                 <?php } ?>
                                    ...
                                    <?php if(!empty(Session::get('acl')[46][13])){ ?>
                                    @if($editId->enlistment_status=='approved' || $editId->enlistment_status=='waiting-for-approval')
                                        <a class="btn btn-danger  reject" id="{{$editId->id}}" href="{{ URL::to('suppliers/enlistment/rejected/' . $editId->id ) }}" title="Reject" onclick="return confirm('Are you Sure?')">
