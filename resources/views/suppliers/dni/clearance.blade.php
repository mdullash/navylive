        ...
        <div class="row">
            <div class="col-sm-6 col-md-12">
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        {{ Form::open(array('role' => 'form', 'url' => 'suppliers/dni/store/'.$suppliers->id, 'files'=> true, 'class' => '', 'id'=>'')) }}
                        ...
                        <div class="row">
                                   ...
                                   <?php $sl=0;  ?>
                                    @foreach($suppliers->supplierInfos()->get() as $sc)
                                        <tr>
                                            ...
                                            <td> <textarea name="supplier[{!! $sc->id !!}]" class="form-control" placeholder="Description">{!! $sc['pivot']->dni_description !!}</textarea>
                                            </td>
                            ...
                            <div class="form-group">
                                <div class="col-md-12 ">
                                    <?php if(!empty(Session::get('acl')[49][12])){ ?>

                                @if($suppliers->dni_status=='waiting-for-approve')
                                    <a class="btn btn-info   pull-left" id="{{$suppliers->id}}" href="{{ URL::to('suppliers/dni/approved/' . $suppliers->id ) }}" title="Approved" onclick="return confirm('Are you sure ?')">
