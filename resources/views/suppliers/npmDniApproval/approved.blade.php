                ...
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            {{ Form::open(array('role' => 'form', 'url' => 'suppliers/dni-npm-approval/'.$segment3, 'files'=> true, 'method'=>'get', 'class' => 'form-horizontal', 'id'=>'supplier-report')) }}
                        ...
                        <ul class="nav nav-tabs">
                                ...
                                <li @if($segment=='pending') class="active" @endif><a href="{{URL::to('suppliers/dni-npm-approval')}}">Pending</a></li>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped middle-align">
                                ...
                                <tr class="center">
                                    ...
                                    <?php if(!empty(Session::get('acl')[51][1]) || !empty(Session::get('acl')[51][1])){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="action-center">
                                                <div class="text-center">
                                                    ...
                                                    <?php if(!empty(Session::get('acl')[51][1])){ ?>
                                                    <a class="btn btn-success btn-xs" href="{{ URL::to('suppliers/dni-npm-approval/' . $sc->id . '/view') }}" title="Update Info">
