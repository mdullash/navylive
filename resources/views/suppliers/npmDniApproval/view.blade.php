            ...
            <div class="col-sm-6 col-md-12">
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            {{ Form::open(array('role' => 'form', 'url' => 'suppliers/dni-npm-approval/update/'.$dni_npm_approval->id, 'files'=> true, 'class' => '', 'id'=>'')) }}
                            ...
                            <div class="section">
                                ...
                                <div class="col-md-12 ">
                                    <?php if(!empty(Session::get('acl')[51][12])){ ?>

                                    @if($dni_npm_approval->status=='waiting-for-approve')
                                        <a class="btn btn-info  pull-left" id="{{$dni_npm_approval->id}}" href="{{ URL::to('suppliers/dni-npm-approval/approve/' . $dni_npm_approval->id ) }}" title="Approve" onclick="return confirm('Are you sure ?')">
                                    ...
                                    <?php if(!empty(Session::get('acl')[51][3])){ ?>
