            ...
            <div class="col-lg-12">
                <div class="hpanel">
                    <div class="panel-heading hbuilt">
                        <h3>Suppliers <button class="btn-primary" onclick="window.close()">Back</button></h3>
                    </div>
                            ...
                            <div class="tab-content panel">
                                ...
                                <div role="tabpanel" class="tab-pane active" id="supplierInf">
                                    <table class="table table-bordered table-hover table-striped middle-align">
                                        ...
                                        <tr>
                                            <th>{{'Company Logo'}}</th>
                                            <td><img width="100" height="80" src="{!! $nsd_n_link !!}/public/uploads/supplier_profile/{{$suppliers->profile_pic}}"></td>

                                            <th>{{'TIN Certificate'}}</th>
                                            <td><img width="100" height="80" src="{!! $nsd_n_link !!}/public/uploads/supplier_profile/{{$suppliers->tin_certificate}}"></td>
                                        </tr>
                                        <tr>
                                            <th>{{'Testimonial'}}</th>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img width="100" height="80" src="{!! $nsd_n_link !!}/public/uploads/supplier_profile/{{$suppliers->attested_photo}}"></td>

                                            <th>{{'Attested trade license'}}</th>
                                            <td><img width="100" height="80" src="{!! $nsd_n_link !!}/public/uploads/supplier_profile/{{$suppliers->attested_trade_lic}}"></td>
                                        </tr>
                                        <tr>
                                            <th>{{'Attested NID card photocopy'}}</th>
                                            <td><img width="100" height="80" src="{!! $nsd_n_link !!}/public/uploads/supplier_profile/{{$suppliers->attested_nid_photocopy}}"></td>

                                            <th>{{'Attested character certificate'}}</th>
                                            <td><img width="100" height="80" src="{!! $nsd_n_link !!}/public/uploads/supplier_profile/{{$suppliers->attested_char_cert}}"></td>
                                        </tr>
                                        <tr>
                                            <th>{{'Attested VAT registration certificate'}}</th>
                                            <td><img width="100" height="80" src="{!! $nsd_n_link !!}/public/uploads/supplier_profile/{{$suppliers->att_vat_reg_cert}}"></td>

                                            <th>{{'Attested VAT return last certificate'}}</th>
                                            <td><img width="100" height="80" src="{!! $nsd_n_link !!}/public/uploads/supplier_profile/{{$suppliers->att_vat_return_last_cert}}"></td>
                                        </tr>
                                        <tr>
                                            <th>{{'Attested educational certificate'}}</th>
                                            <td><img width="100" height="80" src="{!! $nsd_n_link !!}/public/uploads/supplier_profile/{{$suppliers->att_edu_cert}}"></td>

                                            <th>{{'Last six months bank statement'}}</th>
                                            <td><img width="100" height="80" src="{!! $nsd_n_link !!}/public/uploads/supplier_profile/{{$suppliers->lst_six_mnth_bnk_sttmnt}}"></td>
                                        </tr>
                                        <tr>
                                            <th>{{'Bank solvency certificate'}}</th>
                                            <td><img width="100" height="80" src="{!! $nsd_n_link !!}/public/uploads/supplier_profile/{{$suppliers->bnk_solvency_certi}}"></td>

                                            <th>{{'Affidavit in non-judicial stamp'}}</th>
                                            <td><img width="100" height="80" src="{!! $nsd_n_link !!}/public/uploads/supplier_profile/{{$suppliers->non_judicial_stamp}}"></td>
                                        </tr>
                                    ...
                                    @if(!empty($supplierPersonalInfo))
                                        <table class="table table-bordered table-hover table-striped middle-align">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img width="100" height="80" src="{!! $nsd_n_link !!}/public/uploads/supplier_profile/{{$supplierPersonalInfo->applicant_signature}}">
                                                </td>
                                                <th>{{"Applicant Seal"}}</th>
                                                <td>
                                                    <img width="100" height="80" src="{!! $nsd_n_link !!}/public/uploads/supplier_profile/{{$supplierPersonalInfo->applicant_seal}}">
                                                </td>
                                            </tr>
                                            <tr>
