            ...
            <div class="col-lg-12">
                <div class="hpanel">
                    <div class="panel-heading hbuilt">
                        <?php if(!empty(Session::get('acl')[57][2])){ ?>
                        <div class="pull-right">
                            <a class="btn btn-info btn-effect-ripple" href="{{ URL::to('suppliers/renew-supplier/create') }}"><i class="fa fa-plus"></i> Add New</a>
                        </div>
                        <?php } ?>
                        <h3>Renew Supplier</h3>
                    </div>
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            {{ Form::open(array('role' => 'form', 'url' => 'suppliers/renew-supplier', 'files'=> true, 'method'=>'get', 'class' => 'form-horizontal', 'id'=>'schedule-all')) }}
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped middle-align">
                                ...
                                <tr class="center">
                                    ...
                                    <th class="text-center">{{'Supplier Nmae'}}</th>
                                    <th class="text-center">{{'Mobile Number'}}</th>
                                    <th class="text-center">{{'Barcode Number'}}</th>
                                    <th class="text-center">{{'Email'}}</th>
                                    <th class="text-center">{{'Amount'}}</th>
                                    <?php if(!empty(Session::get('acl')[57][2]) || !empty(Session::get('acl')[57][1])){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="action-center">
                                                <div class="text-center">
                                                    ...
                                                    <?php if(!empty(Session::get('acl')[57][2])){ ?>
                                                    <a class="btn btn-primary btn-xs" href="{{ URL::to('suppliers/renew-supplier/print-renew-supplier/' . $sc->id) }}" title="Print" target="_blank">
                                                        <i class="fa fa-print"></i>
                                                    </a>
                                                    <?php } ?>

                                                    <?php if(!empty(Session::get('acl')[57][4])){?>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $(".exbtovdelete").click(function (e) {
                ...
                var id = this.id;
                var url='{!! URL::to('/suppliers/renew-supplier/destroy') !!}'+'/'+id;
