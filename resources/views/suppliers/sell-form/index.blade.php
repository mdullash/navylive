                ...
                <div class="hpanel">
                    <div class="panel-heading hbuilt">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-info btn-effect-ripple" href="{{ URL::to('suppliers/sells-form/create') }}"><i class="fa fa-plus"></i> Add New</a>
                        </div>
                        <?php } ?>
                        <h3>Sell Form</h3>
                    </div>
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            {{ Form::open(array('role' => 'form', 'url' => 'supplier/sell-form/index', 'files'=> true, 'method'=>'get', 'class' => 'form-horizontal', 'id'=>'schedule-all')) }}

                            <div class="col-md-3">
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <label for="email">Mobile Number: </label>
                                        {!!  Form::text('mobile_number', $mobile_number, array('id'=> 'mobile_number', 'class' => 'form-control', 'autocomplete'=> 'off','placeholder' => 'Mobile No.')) !!}
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="action-center">
                                                <div class="text-center">
                                                    ...
                                                    <?php if(!empty(Session::get('acl')[47][2])){ ?>
                                                    <a class="btn btn-primary btn-xs" href="{{ URL::to('suppliers/sells-from/print-sells-from/' . $sc->id) }}" title="Print" target="_blank">
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $(".exbtovdelete").click(function (e) {
                ...
                var id = this.id;
                var url='{!! URL::to('/suppliers/sells-from/destroy') !!}'+'/'+id;
