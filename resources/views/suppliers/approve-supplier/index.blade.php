                ...
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            {{ Form::open(array('role' => 'form', 'url' => 'suppliers/supplier-approval/', 'files'=> true, 'method'=>'get', 'class' => 'form-horizontal', 'id'=>'supplier-report')) }}
                        ...
                        <ul class="nav nav-tabs" style="margin-bottom: 20px;">
                            ...
                            ?>
                            <li @if($segment2=='supplier-approval')class="active" @endif><a href="{{URL::to('suppliers/supplier-approval')}}">Pending</a></li>
                        ...
                        {{ Form::open(array('role' => 'form', 'url' => 'suppliers/supplier-approval/store', 'files'=> true, 'class' => '', 'id'=>'')) }}
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped middle-align" style="margin-top: 20px;">
                                ...
                                <div class="col-md-12 ">
                                    ...
                                    <?php if(!empty(Session::get('acl')[56][2])){ ?>
