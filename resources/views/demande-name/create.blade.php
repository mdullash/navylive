        ...
        <div class="row">
            <div class="col-sm-6 col-md-12">
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        {{ Form::open(array('role' => 'form', 'url' => 'demande/store', 'files'=> true, 'class' => 'form-horizontal demande', 'id'=>'demande')) }}
                        ...
                        <div class="form-group"><label class="control-label col-md-4 no-padding-right" for="stall_id">Code :<span class="text-danger">*</span></label>
                            <div class="col-md-5">
                                {!!  Form::text('alise', old('alise'), array('id'=> 'alise', 'class' => 'form-control')) !!}
                            </div>
                        </div>

                        <div class="form-group"><label class="control-label col-md-4 no-padding-right" for="stall_id">Address :</label>
                            <div class="col-md-5">
                                {!!  Form::textarea('address', old('address'), array('id'=> 'address', 'class' => 'form-control','rows'=>3)) !!}
                            </div>
                        </div>

                        <div class="form-group"><label class="control-label col-md-4 no-padding-right" for="stall_id">Remark :</label>
                            <div class="col-md-5">
                                {!!  Form::textarea('remark', old('remark'), array('id'=> 'remark', 'class' => 'form-control','rows'=>3)) !!}
                            </div>
                        </div>
