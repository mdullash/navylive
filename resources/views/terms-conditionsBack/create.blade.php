                ...
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group"><label class="control-label col-md-3 no-padding-right" for="stall_id">Description :<span class="text-danger">*</span></label>
                            <div class="col-md-6">
                                @if(!empty($data))
                                    {!!  Form::textarea('descriptions', $data->descriptions, array('id'=> 'descriptions', 'rows' => '3', 'class' => 'form-control', 'required' => 'true')) !!}
                                @else
                                    {!!  Form::textarea('descriptions','', array('id'=> 'descriptions', 'rows' => '3', 'class' => 'form-control', 'required' => 'true')) !!}
                                @endif
                            </div>
                        </div>
