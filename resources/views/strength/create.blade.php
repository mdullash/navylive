        ...
        <div class="row">
            <div class="col-sm-6 col-md-12">
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        {{ Form::open(array('role' => 'form', 'url' => '/strength-calculation/store', 'files'=> true, 'class' => 'form-horizontal items', 'id'=>'items')) }}
                        ...
                        <div class="row">
                                <div class="col-md-12 parentDiv" id="item-lis">
                                    ...
                                    <div class="form-group col-md-2 col-sm-2"><label class="control-label col-md-12 no-padding-right" for="stall_id">Total :<span class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                            {!!  Form::text("total[]", old("days[]"), array("id"=> "days", "class" => "form-control total","step" => "any","readonly")) !!}
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-12" style="padding-left: 38px;">
                                <a href="#" class="btn btn-danger" title="Add More" id="add-more">
                                    <i class="fa fa-plus"></i>
                                </a>
                            </div>

                            <div class="form-group" style="padding-right: 102px;">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var itemList = '<div class="col-md-12 parentDiv new-item" id="item-lis">\n' +
                ...
                '                                    <div class="form-group col-md-2 col-sm-2"><label class="control-label col-md-12 no-padding-right" for="stall_id">Total :<span class="text-danger">*</span></label>\n' +
                '                                        <div class="col-md-12">\n' +
                '                                            {!!  Form::number("total[]", old("days[]"), array("id"=> "total", "class" => "form-control total","step" => "any","readonly")) !!}\n' +
                '                                        </div>\n' +
                '                                    </div>\n' +
                '                                    <div class="form-group col-md-1 col-sm-1">\n' +
                '                                        <label style="" class="control-label col-md-12 no-padding-right" for="stall_id"></label>\n' +
                ...
                '                                    <a href="#" class="btn btn-danger pull-right remove" title="Remove" >\n' +
            ...
            $(document).on('input','.person, .days',function(){
                ...
                $(this).closest("div.parentDiv").find(".total").val(parseFloat(totalCal).toFixed(2));
            });
        });
    </script>
@stop
