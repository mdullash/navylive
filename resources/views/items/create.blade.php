            ...
            <div class="col-sm-6 col-md-12">
                <div class="hpanel">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6 col-sm-6"><label class="control-label col-md-5 no-padding-right" for="stall_id">Main Equipment Additional Info:</label>
                            <div class="col-md-7">
                        ...
                        <div class="form-group col-md-6 col-sm-6">
                            ...
                            <div class="col-md-7">
                                <select class="form-control selectpicker" name="item_type" id="item_acct_status">
                                   ...
                                   <option value="3">Quasi Permanent</option>
                            ...
                            <div class="col-md-7">
                                <select class="form-control selectpicker" name="nsd_id[]" id="nsd_id"  data-live-search="true" multiple="multiple">
                                    ...
                                    @foreach($nsdNames as $nn)
                                        <option value="{!! $nn->id !!}" @if($orgInfo->name == $nn->name) selected @endif>{!! $nn->name !!}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-6 col-sm-6">
                            <label for="permanent_or_waste_content1" class="control-label col-md-5 no-padding-right">Item's Type<span class="text-danger">*</span></label>
                            <div class="col-md-7">
                                <select class="form-control selectpicker" name="item_type_r" id="item_type" required>
                                    ...
                                    <option value="4">Main Equipment</option>
                        ...
                        <div class="form-group">
                            <div class="col-md-7 col-sm-offset-5">
                                ...
                                <button type="submit" class="btn btn-success pull-right">{!!trans('english.SAVE')!!}</button>
