...
<body>
    ...
    <table style="width: 100%;font-size: 14px;">
        <tr>
            <td style="width: 128mm; font-size: 14px;">D-44B No: {!! $d44bInfo->d44b_no !!}</td>
            <td style=" font-size: 14px;">Date of Delivery: </td>
        </tr>
        <tr>
            <td style="font-size: 14px;">D-44B Date: {!! date('Y-m-d',strtotime($d44bInfo->d44b_date)) !!}</td>
            <td style=" font-size: 14px; ">Receive Date: {!! date('Y-m-d',strtotime($valuesFi->item_receive_date)) !!}</td>
        </tr>
        <tr>
            <td style="font-size: 14px;">PO No: {!! $poDatasInfo->po_number !!}</td>
            <td style="font-size: 14px;">Delay of Supply: </td>
        </tr>
        <tr>
            <td style="font-size: 14px;">PO Date: {!! date('Y-m-d',strtotime($poDatasInfo->top_date)) !!}</td>
    ...
    <table style="width: 100%;">
        ...
        @if(!empty($firstPerSon))
            <td style="width: 128mm; font-size: 14px;">
