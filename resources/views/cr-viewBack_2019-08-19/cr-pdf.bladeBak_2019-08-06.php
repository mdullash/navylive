...
<body>
    ...
    <!-- <tbody  style="width: 215.9mm;"> -->
        <tr>
            <td style="width: 71.96mm;"></td>
            <td style="width: 78.04mm;"></td>
    ...
    <table  style="width: 100%;">
        <tr>
            <td colspan="3" style="font-size: 14px;">1.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Challan         -       04 (Four) Copies. </td>
        </tr>
        <tr style="height: 2mm;"></tr> 
        <tr>
            <td colspan="3" style="font-size: 14px;">2.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Ref: “A”        -       01 (One)  Copy. </td>
        </tr>
        <tr style="height: 2mm;"></tr> 
        <tr>
            <td colspan="3" style="font-size: 14px;">2.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Warranty Certificate    -       02  (Two) Copies. </td>
        </tr>
    </table>
    <br>
    <table>
