...
<body>
    ...
    <!-- <tbody style="width: 215.9mm;"> -->
        ...
        <tr>
            ...
            <td style=""></td>
            <td ></td>
            <td style="font-size: 14px; text-align: right; width: 55mm;">{!! (!empty($crNumberInfo->item_receive_date)) ? date('d',strtotime($crNumberInfo->item_receive_date)) : '' !!}</td>
    ...
    <table>
        <tr>
            <td colspan="3" style=" font-size: 14px; font-weight: bold;"><span style="border-bottom: 1px solid black;font-family: ARIAL;">REQUEST FOR INSPECTION OF STORES/ITEMS RECEIVED AGAINST WORK ORDER</span></td>
        </tr>
        <tr>
            <td></td>
        </tr>
    ...
    <table  style="width: 100%;">
        <tr>
            <td style="font-size: 14px;">{!! nl2br($crNumberInfo->info) !!}</td>
        </tr>
        <tr style="height: 2mm;"></tr>
    </table>
    <br>
