                    ...
                    <div class="panel-body">
                        {{ Form::open(array('role' => 'form', 'url' => 'post-po-approve-edit', 'files'=> true, 'class' => '', 'id'=>'')) }}
                            ...
                            <div class="row paddingClass">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="extends_tender_number" class="col-md-3">PO Number<span class="text-danger">*</span></label>
                                        <div class="col-md-6">
                        ...
                        <div class="row paddingClass">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <textarea type="text" name="info" class="form-control" id="info" >{{$podataInfo->info}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
