...
{{--{{dd($demandToCollQut)}}--}}
    ...
    @foreach($demandToCollQut as $dtcq)
        <table style="width: 100%;">
            ...
            <table>
                <tr>
                    <td colspan="3" style=" font-size: 14px; font-weight: bold;"><h3 style="text-decoration: underline;">LOCAL PURCHASE ORDER-{!! (!empty($tenderInfo->tender_title)) ? $tenderInfo->tender_title : '' !!}@if(!empty($demandToLprInfo->for_whom)) {{'-'.$demandToLprInfo->for_whom}} @endif</h3></td>
                </tr>
                <tr>
                    <td></td>
                </tr>
