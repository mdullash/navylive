...
{{--{{dd($demandToCollQut)}}--}}
    ...
    @foreach($demandToCollQut as $dtcq)
        <table style="width: 100%;">
            ...
            <table>
                <tr>
                    <td colspan="3" style=" font-size: 14px; font-weight: bold;text-align: justify;text-transform: uppercase;"><h3 style="text-decoration: underline;text-align: justify;">LOCAL PURCHASE ORDER-{!! (!empty($tenderInfo->tender_title)) ? $tenderInfo->tender_title : '' !!}@if(!empty($tenderInfo->demending)) {{'-'.$tenderInfo->demending}} @endif</h3></td>
                </tr>
                <tr>
                    <td></td>
                </tr>
                ...
                <tr>
                    <td colspan="3" style=" font-size: 14px;">Reference:</td>
                </tr>
                <tr>
                    <td></td>
                </tr>
            ...
            <table>
                <tr>
                    ...
                    <td colspan="3" style=" font-size: 15px;text-align: justify;"><span>1 .</span>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;In light of approval <span style="">
                            at</span> ref 'b', subject mentioned item(s) <span style=" ">
                        ...
                        You are hereby awarded with the @if($podataInfo->is_contract_with == 1) contract @else @if($tenderInfo->invitation_for == "Purchase of Goods" || $tenderInfo->invitation_for == "Exchange") purchase @else work @endif order @endif of Taka {!! ImageResizeController::custom_format($totalAmountAfterDiscount) !!}
                        ...
                        </span> As such you are requested to supply the item(s) to <span style="">
                            {!! (!empty($podataInfo->supply_to)) ? $podataInfo->supply_to : '' !!}</span>
                        by complying the following conditions as mentioned below:</td>
                        @else
                            <td colspan="3" style=" font-size: 15px;text-align: justify;"><span>1 .</span>&nbsp; &nbsp; &nbsp;In light of references, tenders above mentioned item(s) have been approved in principle by NSSD Dhaka complying with quotation of tender.
...
@if($podataInfo->is_enclosure == 1)
        <table  style="width: 100%;margin-left: 38px;" class="table-bordered">
            <!-- <tbody  style="width: 215.9mm;"> -->
                <tr>
	        ...
	        $selectedSupItemInfo[$dtcq->id];
                ...
                <tr>
                    ...
                    <td style="font-size: 14px;">{!! $tenderInfo->tender_title !!} <br>
                        <span style="font-size: 14px;">( {{$itemCount}} Line item(s) As Per Attach List )</span>
                    </td>
        ...
        @else
    <table  style="width: 100%;margin-left: 37px;" class="table-bordered">
        <!-- <tbody  style="width: 215.9mm;"> -->
        <tr>
            <td style="border: 0;  font-size: 14px;"></td>
            <td style="font-size: 14px;">Ser</td>
    ...
    @endif
        ...
        <table  style="width: 100%;">
            <!-- <tbody  style="width: 215.9mm;"> -->
                ...
                <tr style="font-size: 14px;padding-left: 37px;"></tr>
                <?php 
                ...
                @if(!empty($termsConditions))
                    ...
                    <tr>
                        <td style="font-size: 14px;padding-left: 37px;"></td>
                        <td style="text-align: justify;"> <?php echo $sln++;?>. &nbsp;&nbsp;&nbsp; {!! $tc !!}</td>
                    </tr>
                    @endforeach
                @endif
            <!-- </tbody> -->
        	...
        	<tr>
                    ...
                    <td style="font-size: 14px;" colspan="2">
                        @if($podataInfo->is_contract_with == 1)
                            2.&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;Contract for the purchase is enclosed herewith.
                            @else
                            2.&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; @if($tenderInfo->invitation_for == "Purchase of Goods" || $tenderInfo->invitation_for == "Exchange") Purchase @else Work @endif order will be consider as a contract for this purchase.
                            @endif
                    </td>
                </tr>
        </table>
        ...
        <table  style="width: 100%;">
            <!-- <tbody  style="width: 215.9mm;"> -->
                ...
                <tr>
                    ...
                    <td style="font-size: 14px;">
                        @if(!empty($podataInfo->poApprovalName))
                        {!! !empty($podataInfo->po_approved_rank) ? $podataInfo->po_approved_rank : $podataInfo->poApprovalName->rank !!}
                        @endif
                    </td>
                </tr>                
                <tr>
        ...
        <table  style="width: 100%;">
            <!-- <tbody  style="width: 215.9mm;"> -->
                @if(!empty($podataInfo->inclusser))
                 ...
                 <?php 
                        $enclosers = $podataInfo->inclusser;
                        if(!empty($enclosers)){
                            $enclosers = explode('<br>', $enclosers); 
                        }
                        $tsln = 1;
                ?>
                ...
                <tr>
                    <td colspan="6" style="font-size: 14px;">External:</td>
                </tr>
                <tr>
                ...
                <tr>
                    <?php $suppInfo = \App\Supplier::find($dtcq->supplier_name); ?>
                    <td colspan="6" style="font-size: 14px;">Information:</td>
                </tr>
...
<br /><br /><br /><br /><br /><br /><br /><br /><br /><br />
    ...
    <h3 align="center"><span style="font-size: 20px;">তারিখ</span> <u>{!! (!empty($podataInfo->top_date)) ? date('d F Y',strtotime($podataInfo->top_date)) : '' !!}</u></h3>
    ...
    @if($dtcq->total > $orgInfo->purchase_limit)
        ...
        <p style="font-size: 18px;margin-left: 40px;">ক। &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            নৌ সদর পত্র নং <span style="font-size: 14px;">  {!! (!empty($tenderInfo->nhq_app_ltr_number)) ? $tenderInfo->nhq_app_ltr_number : '' !!} </span> 
    ...
    <table  style="width: 100%;">
        ...
        <tr>
            ...
            <td style="font-size: 14px;">
                @if(!empty($podataInfo->poCheckerName))
                    {!! !empty($podataInfo->po_check_rank) ? $podataInfo->po_check_rank : $podataInfo->poCheckerName->rank !!}
                @endif
            </td>
        </tr>
        <tr>
...
?>
    <p style="margin-left: 40px;font-size: 18px;">খ । &nbsp;&nbsp;&nbsp;&nbsp; চুক্তিকৃত সামগ্রী চুক্তি স্বাক্ষরের পর হতে <span style="font-size: 14px;">{{!empty($podataInfo->supply_date) ? date("d F Y",strtotime($podataInfo->supply_date)):''}}</span> তারিখের মধ্যে পরিদর্শন কর্মকর্তা কর্তৃক
      পরিদর্শন করত:
        @if ($tenderInfo->invitation_for == "Purchase of Goods" || $tenderInfo->invitation_for == "Exchange")
            সরবরাহ
        @else
...
<br />
    ...
    <table class="border" style="margin-left: 80px;font-size: 18px;width: 100%;">
        ...
        <tr>
            ...
            <td style="text-align: center;">_____পাতা</td>
        </tr>
        <tr>
