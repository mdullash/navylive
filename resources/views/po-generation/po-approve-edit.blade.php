        ...
        <div class="row">
            <div class="col-sm-6 col-md-12">
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        {{ Form::open(array('role' => 'form', 'url' => 'post-po-approve-edit', 'files'=> true, 'class' => '', 'id'=>'')) }}
                            ...
                            <div class="col-md-6">
                                <div class="row paddingClass">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="extends_tender_number" class="col-md-12">PO/WO Number<span class="text-danger">*</span></label>
                                            <div class="col-md-12">
                                                <input type="po_number" class="form-control col-md-12" name="po_number" id="po_number" value="{!! $podataInfo->po_number !!}" required="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row paddingClass">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea style="white-space: pre-wrap;" type="text" name="inclusser" class="form-control" id="inclusser" >{{$podataInfo->inclusser}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
