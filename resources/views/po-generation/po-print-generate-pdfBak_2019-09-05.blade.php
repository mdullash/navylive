    ...
    @foreach($demandToCollQut as $dtcq)
        <table style="width: 100%;">
            ...
            <table>
                ...
                @endif
                <tr>
                    <td colspan="3" style=" font-size: 14px;">@if($dtcq->total <= $orgInfo->purchase_limit) B @else A @endif.&nbsp;&nbsp;&nbsp;{!! (!empty($orgInfo->name)) ? $orgInfo->name : '' !!} tender no. {!! (!empty($tenderInfo->tender_number)) ? $tenderInfo->tender_number : '' !!} . Date {!! (!empty($tenderInfo->valid_date_from)) ? date('d F Y',strtotime($tenderInfo->valid_date_from)) : '' !!}.</td>
                </tr>
                @if($dtcq->total > $orgInfo->purchase_limit)
                <tr>
...
@if($podataInfo->is_enclosure == 1)
        <table  style="width: 100%;margin-left: 25px;" class="table-bordered">
            <!-- <tbody  style="width: 215.9mm;"> -->
                <tr>
	        ...
	        $selectedSupItemInfo[$dtcq->id];
                ...
                <tr>
                    ...
                    <td style="font-size: 14px;">&nbsp; 
                        {!! ImageResizeController::custom_format($totalAmountss) !!}
                    </td>
                </tr>
                <!-- <tr>
                ...
                <tr>
                    ...
                    <td style="font-size: 14px;">&nbsp; {!! ImageResizeController::custom_format($totalAmountss) !!}</td>
                </tr>
                @if(!empty($dtcq->discount_amount))       
                <tr>
                    <td style="border: 0"></td>
                    <td colspan="2" style="text-align: right;">&nbsp; Price Reduction/Discount (-) &nbsp;</td>
                    <td style="font-size: 14px;">&nbsp; {!! ImageResizeController::custom_format($dtcq->discount_amount) !!}</td>
                </tr> 
                @endif
                <tr>
                    <td style="font-size: 14px; border: 0"></td>
                    ...
                    <td style="font-size: 14px;">&nbsp; {!! ImageResizeController::custom_format($totalAmountss-$dtcq->discount_amount) !!}&nbsp;</td>
                </tr>  
                <tr style="height: 4mm;"></tr>
            <!-- </tbody> -->
        </table>
        @else
    <table  style="width: 100%;margin-left: 24px;" class="table-bordered">
        <!-- <tbody  style="width: 215.9mm;"> -->
        <tr>
            <td style="border: 0;  font-size: 14px;"></td>
            <td style="font-size: 14px;">&nbsp;Ser</td>
    ...
    <!-- <tr>
        ...
        <tr>
            ...
            <td style="font-size: 14px;">&nbsp; {!! ImageResizeController::custom_format($totalAmount-$dtcq->discount_amount) !!} &nbsp;</td>
        </tr>
        <tr style="height: 4mm;"></tr>
        <!-- </tbody> -->
    </table>
...
@if($podataInfo->is_contract_with == 1)
    ...
    <htmlpageheader name="contract-page-header">
        <p style="text-align: center;font-size: 12px;font-family: serif;">OFFICIAL USE ONLY</p>
    </htmlpageheader>


    <htmlpagefooter name="contract-page-footer">
        <table style="vertical-align: bottom; font-family: serif; color: #000000;" width="100%">
            <tbody>
            <tr>
                <td style=" font-style: italic; font-size: 14px;" align="left" width="31%;">Page {PAGENO} of {nbpg}</td>
                <td style="font-size: 12px;" align="center" width="31%;">OFFICIAL USE ONLY</td>
                <td style=" font-style: italic; font-size: 14px;" align="right" width="31%;">{!! date('d-m-Y') !!}</td>
            </tr>
            </tbody>
        </table>
    ...
    <sethtmlpageheader name="contract-page-header" show-this-page="1" value="on" />
    <sethtmlpagefooter name="contract-page-footer" value="on" />
<br /><br /><br /><br /><br /><br /><br /><br /><br /><br />
    ...
    <h3 align="center"><span style="font-size: 20px;">চুক্তিপত্র নং : </span> <u>{{!empty($podataInfo->po_number) ?$podataInfo->po_number : ''}}</u> <span style="font-size: 20px;">তারিখ</span> <u>{!! (!empty($podataInfo->top_date)) ? date('d F Y',strtotime($podataInfo->top_date)) : '' !!}</u></h3>
    ...
    @if($dtcq->total > $orgInfo->purchase_limit)
        ...
        <p style="font-size: 18px;margin-left: 40px;">ক &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            নৌ সদর পত্র নং {{!empty($podataInfo->headquarters_letter_no) ? $podataInfo->headquarters_letter_no : ''}}
            তারিখ  <span style="font-size: 14px;">{{!empty($podataInfo->top_date) ? date('d F Y',strtotime($podataInfo->top_date)) : ''}}</span></p>
        @endif
    ...
    <p style="font-size: 18px;margin-left: 40px;font-weight: 700">চুক্তিপত্র নং : <span style="font-size: 14px;"> <u>{{!empty($podataInfo->po_number) ?$podataInfo->po_number : ''}}</u></span> তারিখ <span style="font-size: 14px;"><u>{!! (!empty($podataInfo->top_date)) ? date('d F Y',strtotime($podataInfo->top_date)) : '' !!}</u></span></p>
    <p style="font-size: 18px;margin-left: 40px;">এর অধীনে যেসব মালামাল সরবরাহ করা হবে তার তফসিল :</p>

    <table  style="width: 100%;margin-left: 40px;" class="table-bordered">
        <!-- <tbody  style="width: 215.9mm;"> -->
        <tr>
            <td style="border: 0;  font-size: 14px;"></td>
            <td style="font-size: 14px;">&nbsp;Ser</td>
 ...
 <p style="margin-left: 40px;font-size: 18px;">ক । &nbsp;&nbsp;&nbsp;&nbsp; চুক্তিকৃত সমস্ত সামগ্রী চুক্তিপত্রের সাথে এনেক্স -বি হিসাবে সংযুক্ত চুক্তির বির্নিদেশ
     <span style="font-size: 14px;">(Contract Specification)</span> মোতাবেক বাংলাদেশ নৌবাহিনীর অনূকুলে সরবরাহ সম্পন্ন করতে হবে । </p>
<?php
...
?>
    <p style="margin-left: 40px;font-size: 18px;">খ । &nbsp;&nbsp;&nbsp;&nbsp; চুক্তিকৃত সামগ্রী চুক্তি স্বাক্ষরের পর হতে <span style="font-size: 14px;">{{$deliveryDaysAdd}}</span> তারিখের মধ্যে পরিদর্শন কর্মকর্তা কর্তৃক
      পরিদর্শন করত: সরবরাহ করতে হবে। সুম্পূর্ণ মালামাল সরবরাহ সম্পন্ন হওয়ার পরই বিল পরিশোধ করা হবে ৷</p>
    ...
    <p style="margin-left: 40px;font-size: 18px;">ঘ ৷ &nbsp;&nbsp;&nbsp;&nbsp; আংশিক মালামাল সরবরাহ এবং আংশিক বিল পরিশোধ গ্রহনযোগ্য হবে না ৷</p>

    <p style="margin-left: 40px;font-size: 18px;">ঙ ৷ &nbsp;&nbsp;&nbsp;&nbsp; সমস্ত মালামাল সরবরাহকারীর নিজ দায়িত্বে ও নিজ খরচে গ্রহীতার নিকট পোছাইতে হবে।</p>

    <p style="margin-left: 40px;font-size: 18px;">চ ৷ &nbsp;&nbsp;&nbsp;&nbsp; সরবরাহের পরকোন  আইটেম ব্যবহারের  অনুপযোগী পাওয়া গেলে  সরবরাহকারীকে নিজ ও নিজ দায়িত্বে খরচ উক্ত আইটেম পরিবর্তন করে দিতে হবে ।</p>
<?php
    $valueR = '';
    if ($tenderInfo->invitation_for == "Purchase of Goods"){
	    $valueR = " আসল, নতুন";
    }else if($tenderInfo->invitation_for == "Repair & Upgradation"){
        $valueR = " মেরামত ও আপগ্রেডেশন ";
    }else if($tenderInfo->invitation_for == "Maintenance"){
        $valueR = " মরক্ষণাবেক্ষণ ";
    }else if($tenderInfo->invitation_for == "Overhauling"){
        $valueR = " সংস্কার ";
    }else if($tenderInfo->invitation_for == "Exchange"){
        $valueR = " বিনিময় ";
    }else{
        $valueR = " মেরামত ";
	    }
?>
    <p style="margin-left: 40px;font-size: 18px;">ছ ৷ &nbsp;&nbsp;&nbsp;&nbsp; সামগ্রী সমূহ {{$valueR}} এবং ব্যবহার উপযোগী হতে হবে।</p>
...
?>
    <table style="width: 100%;margin-left: 40px;">
        ...
        <tr>
            ...
            <td style="vertical-align: top;padding: 0 10px;">:</td>
            <td style="font-size: 14px;">
                {{!empty($podataInfo->po_number) ?$podataInfo->po_number : ''}}
                <br />
                <span style="font-size: 18px;">তারিখ</span> {{!empty($podataInfo->top_date) ? date('d F Y', strtotime($podataInfo->top_date)) : ''}}
            </td>
        </tr>
        <tr>
            <td colspan="3">&nbsp;</td>
        ...
        <tr>
            <td style="font-size: 18px;vertical-align: top">৫। মালামাল সরবরাহের শর্তাবলী ও তারিখ </td>
            <td style="vertical-align: top;padding: 0 10px;">:</td>
            <td style="font-size: 14px;">{{$deliveryDaysAdd}}<span style="font-size: 18px;"> তারিখের মধ্যে  সরবরাহ করতে হবে</span></td>
        </tr>
        <tr>
            <td colspan="3">&nbsp;</td>
        </tr>
        ...
        <tr>
            <td style="font-size: 18px;vertical-align: top">৭।  মালামাল প্রস্তুতকারক দেশ </td>
            <td style="vertical-align: top;padding: 0 10px;">:</td>
            <td style="font-size: 14px;vertical-align: top">{{$countryName}}</td>
        </tr>
        <tr>
            <td colspan="3">&nbsp;</td>
        </tr>
        ...
        <tr>
            ...
            <td style="vertical-align: top;padding: 0 10px;">:</td>
            <td style="font-size: 18px;vertical-align: top"> আমদানিকৃত ইটেমের গায়ে অবশ্যই বাংলাদেশ নৌবাহিনী <span style="font-size: 14px;">(BD Navy)</span> কথাটি বড় অক্ষরে লিখতে হবে</td>
        </tr>
    </table>
    <p style="margin-left: 40px;font-size: 18px;">১০।  পরিদর্শন : পরিদর্শনের জন্য নিম্ন বর্ণিত পদ্ধতি অনুসরন করা হবে :</p>
    <p style="margin-left: 80px;font-size: 18px;">ক ৷ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;পরিদর্শন কর্তৃপক্ষ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :&nbsp;&nbsp;</p>
    <p style="margin-left: 80px;font-size: 18px;">খ । &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;পরিদর্শনের স্থান &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :&nbsp;&nbsp;</p>
    <p style="margin-left: 80px;font-size: 18px;text-align: justify;">গ ৷ &nbsp;&nbsp;&nbsp;অনুমোদিত পরিদর্শন কর্তৃপক্ষ চক্তিপত্রের তফসিলের চাহিদা অনুযায়ী মালামাল পরীক্ষা করে দেখবেন ৷ পরিদর্শন কর্তৃপক্ষের
...
<br />
    ...
    <table style="margin-left: 40px;font-size: 18px;">
        ...
        <tr>
            ...
            <td style="text-align: justify;font-size: 18px;"> (ক)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;পরিদর্শনের জন্য সরবরাহকারী কর্তৃক পেশকৃত নমুনা নির্ধারিত মান এনেক্স-বি অনুযায়ী না হলে পরিদর্শক সরবরাহকারীকে পরিদর্শনের জন্য নতুন করে মাল গুদামজাত
                ...
                <br />
                <br />
                (খ) যদি সরবরাহকারী এনেক্স-বি/অনুমোদিত নমুনা অনুযায়ী নতুন করে মালামাল সরবরাহ করতে চান তবেতাকে নিয়ম অনুযায়ী নতুন মাল সরবরাহে যে রিলম্ব হতে পারে তার জন্য আর্থিক ক্ষতিপূরণ দিতে হবে ৷
                <br />
                <br />
                (গ) তবে মূল্য হ্রাসের বিষয়টি চূড়ান্তভাবে ক্রেতা কর্তৃক স্থিরকৃত এবং যেখানে প্রয়োজন হয়, চুক্তিপত্রে সংশিষ্ঠ আনুষ্ঠানিক সংশোধন না হওয়া পর্যন্ত সরবরাহকারী সেসব মালের জন্য বিল দাখিল বা পেশ করা যাবে না।
        </tr>
    </table>
    <br /><br />
    <table style="margin-left: 40px;font-size: 18px;">
        <tr>
            ...
            <td style="text-align: justify;"> <u><strong>নির্ধারিত সময়ের মধ্যে মালামাল সরবরাহে ব্যর্থতা ।</strong></u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;চুক্তিপত্রে উল্লেখিত সময়ের মধ্যে এবং এনেক্স-বি অনুযায়ী মালামাল সরবরাহ করতে
    ...
    <table style="margin-left: 40px;font-size: 18px;">
        <tr>
            ...
            <td style="text-align: justify;"> <u><strong>নির্ধারিত সময়ের মধ্যে মালামাল সরবরাহে ব্যর্থতা ।</strong></u> চুক্তিপত্রে উল্লেখিত সময়ের মধ্যে এবং এনেক্স-বি অনুযায়ী মালামাল সরবরাহ করতে ব্যর্থ হলে ভারপ্রাপ্ত কর্মকর্তা, এনএসএসডি ঢাকা কর্তৃক চুক্তিপত্র বাতিল
    ...
    <table class="border" style="margin-left: 80px;font-size: 18px;width: 100%;">
        ...
        <tr>
            ...
            <td style="text-align: center;">এনিক্স-এ</td>
            <td>আর্থিক সংশ্লেষ</td>
            <td style="text-align: center;">পাতা</td>
        </tr>
        <tr>
            <td style="width: 40px;vertical-align: top;padding-left: 10px;">২ ।</td>
            <td style="text-align: center;">এনিক্স-বি</td>
    ...
    <table  style="width: 100%;margin-left: 80px;" class="table-bordered">
        <!-- <tbody  style="width: 215.9mm;"> -->
        <tr>
            <td style="border: 0;  font-size: 14px;"></td>
            <td style="font-size: 14px;">&nbsp;Ser</td>
