            ...
            <table>
                <tr>
                    ...
                    <td colspan="3" style=" font-size: 15px;text-align: justify;"><span>1 .</span>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;In light of approval <span style="">
                            at</span> ref 'b', subject mentioned item <span style=" ">
        	...
        	<tr>
                    ...
                    <td style="font-size: 14px;" colspan="2">
                        @if($podataInfo->is_contract_with == 1)
                            ...
                            @else
                            2.&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;This @if($tenderInfo->invitation_for == "Purchase of Goods" || $tenderInfo->invitation_for == "Exchange") purchase @else work @endif order will be consider as a contract for purchase.
                            @endif
                    </td>
                </tr>
        </table>
