                                ...
                                <div class="row paddingClass">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="requester" class="col-md-12 text-left">PO/WO Date:<span class="text-danger">*</span></label>
                                            <div class="col-md-12">
                           ...
                           <div class="col-md-6">
                                ...
                                <div class="row paddingClass">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" name="inspection_Authority" class="form-control" id="inspection_Authority" required="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="row paddingClass">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="requester" class="col-md-12 text-left">Supply Date:<span class="text-danger">*</span></label>
                                            <div class="col-md-12">
                                                {!!  Form::text('supply_date','', array('id'=> 'supply_date', 'class' => 'form-control datapicker2', 'required', 'readonly')) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                           ...
                           <div class="row paddingClass">
                               <div class="col-md-6">
                                   <div class="form-group">
                                       ...
                                       <div class="col-md-12">
                                           <textarea type="text" name="info" class="form-control" id="info">DNS/DTS/DNST &#13;&#10;CINS/ACINS/Local Inspection Authority, NSD Dhaka
                                           </textarea>
                                       </div>
                                   </div>
                               </div>
