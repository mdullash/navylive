                ...
                <tr>
                    ...
                    <td style="">
                        ...
                        @if(!empty($podataInfo->poApprovalName->digital_sign))
                            <img src="{{$podataInfo->poApprovalName->digital_sign}}" style="width: 30px;"/>
                            @endif
                    </td>
                </tr>
                <tr>
...
?>
    <table style="width: 100%;margin-left: 40px;">
        ...
        <tr>
            ...
            <td style="vertical-align: top;padding: 0 10px;">:</td>
            <td style="font-size: 14px;vert-align: top;">
...
<br />
    ...
    <P style="text-align: center;font-size: 14px;">Financial Analysis</P>
    <br /><br />
