                                ...
                                @if (!$demands->isEmpty())
                                    ...
                                    @foreach($demands as $sc)
                                        <tr>
                                            ...
                                            <?php if(!empty(Session::get('acl')[34][30]) ){ ?>
                                            <td>
                                                <a class="btn btn-success btn-xs" href="{{ URL::to('po-check-view/'.$sc->id.'&'.$sc->tender_id) }}" title="Check PO">
                                                    <i class="icon-check"></i>
                                                </a>
                                                <a class="btn btn-primary btn-xs" target="_blank" href="{{ URL::to('view-po-generation/'.$sc->id.'&'.$sc->tender_id.'&'.'3') }}" title="Check PO">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                            </td>
                                            <?php } ?>
