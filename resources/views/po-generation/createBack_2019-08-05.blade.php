                            ...
                            <div class="row paddingClass">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="extends_tender_number" class="form-control col-md-4" name="extends_tender_number" id="extends_tender_number" value="{!! $tenderInfo->tender_number !!}" required="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row paddingClass">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            {{ Form::select('import_duties', array('with' => 'with', 'without' => 'without'), old('import_duties'), array('class' => 'form-control selectpicker', 'id' => 'import_duties', 'required')) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row paddingClass">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="supply_to" class="form-control" id="supply_to" value="">
                                        </div>
                                    </div>
                                </div>
                            </div>
