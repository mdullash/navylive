        ...
        <div class="row">
            <div class="col-sm-6 col-md-12">
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        {{ Form::open(array('role' => 'form', 'url' => 'group_name', 'files'=> true, 'class' => 'form-horizontal group_name', 'id'=>'group_name')) }}


                        <div class="form-group"><label class="control-label col-md-4 no-padding-right" for="stall_id">Group Name :<span class="text-danger">*</span></label>
                            <div class="col-md-5">
