        ...
        <div class="row">
            <div class="col-sm-6 col-md-12">
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        {{ Form::open(array('role' => 'form', 'url' => 'retender-post', 'files'=> true, 'class' => 'tender', 'id'=>'tender')) }}

                        <input type="hidden" name="demandToLprId" value="{!! $demand_to_lpr_id !!}">
                        <input type="hidden" name="tenderId" value="{!! $tenderId !!}">
                        <input type="hidden" name="retednderId" value="{!! $retednderId !!}">

                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="requester">Tender Title/Name:<span class="text-danger">*</span></label>
                                    {!!  Form::text('tender_title', old('tender_title',$tenderInfo->tender_title), array('id'=> 'tender_title', 'class' => 'form-control')) !!}
                                </div>
                            </div>
                            ...
                            @if(!empty($demandToLprInfo->demand_no))
                                <div class="col-md-4 ">
                                    <div class="form-group"><label class="control-label" for="stall_id">Demand Number :</label>
                                        {!!  Form::text('ref_tender_id', $demandToLprInfo->demand_no, array('id'=> 'ref_tender_id', 'class' => 'form-control', 'readonly')) !!}
                                    </div>
                                </div>
                            @endif
                            ...
                            @if(empty($demandToLprInfo->demand_no))
                                <div class="col-md-4 hidden">
                                    <div class="form-group"><label class="control-label" for="stall_id">Approval Letter Number :</label>
                                        {!!  Form::text('approval_letter_number', old('approval_letter_number',$tenderInfo->tender_title), array('id'=> 'approval_letter_number', 'class' => 'form-control')) !!}
                                    </div>
                                </div>

                                <div class="col-md-4 hidden">
                                    <div class="form-group"><label class="control-label" for="stall_id">Approve Date :</label>
                                        {!!  Form::text('approval_letter_date', old('approval_letter_date', (!empty($tenderInfo->approval_letter_date)) ? date('Y-m-d',strtotime($tenderInfo->approval_letter_date)) : date('Y-m-d') ) , array('id'=> 'approval_letter_date', 'class' => 'form-control datapicker2', 'readonly')) !!}
                                    </div>
                                </div>
                            @endif
                            ...
                            <div class="col-md-4">
                                <div class="form-group"><label class="control-label " for="valid_date_from">Tender Publishing Date :<span class="text-danger">*</span></label>
                                    {!!  Form::text('valid_date_from', old('valid_date_from', (!empty($tenderInfo->valid_date_from)) ? date('Y-m-d',strtotime($tenderInfo->valid_date_from)) : date('Y-m-d')), array('id'=> 'valid_date_from', 'class' => 'form-control datapicker2','readonly')) !!}
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group"><label class="control-label " for="stall_id">Tender Opening Date :<span class="text-danger">*</span></label>
                                    {!!  Form::text('tender_opening_date', old('date_of_enrollment', (!empty($tenderInfo->valid_date_to)) ? date('Y-m-d',strtotime($tenderInfo->valid_date_to)) : date('Y-m-d') ), array('id'=> 'tender_opening_date', 'class' => 'form-control datapicker2','readonly')) !!}
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group"><label class="control-label" for="tender_type">Tender Type :<span class="text-danger">*</span></label>
                                    {{ Form::select('tender_type', array('' => '- Select -', '1' => 'LTM- Limited Tender Method', '2' => 'OTM- Open Tender Method', '4' => 'Spot Tender', '5' => 'DPM- Direct Purchase Method', '6' => 'Short Tender'), old('tender_type',$tenderInfo->tender_type), array('class' => 'form-control selectpicker', 'id' => 'tender_type')) }}
                                </div>
                            </div>

                            <div class="col-md-4">
                                <div class="form-group"><label class="control-label" for="tender_priority">Tender Priority :</label>
                                    {{ Form::select('tender_priority', array('' => '- Select -', '1' => 'Normal', '2' => 'Immediate', '3' => 'OPS Immediate (Operational Immediate)'), old('tender_priority',$tenderInfo->tender_priority), array('class' => 'form-control selectpicker', 'id' => 'tender_priority')) }}
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 hidden" id="number_of_lot_itemDiv">
                                <div class="form-group"><label class="control-label" for="number_of_lot_item">Number of Lot Item :<span class="text-danger">*</span></label>
                                    {!!  Form::text('number_of_lot_item', old('number_of_lot_item',$tenderInfo->number_of_lot_item), array('id'=> 'number_of_lot_item', 'class' => 'form-control number_of_lot_item')) !!}
                                </div>
                            </div>
                                ...
                                <div class="form-group"><label class="control-label" for="status">Tender Group :<span class="text-danger">*</span></label>
                                    <select class="form-control selectpicker" name="tender_cat_id" id="tender_cat_id"  data-live-search="true">
                                        ...
                                        @foreach($supplyCategories as $sc)
                                            <option value="{!! $sc->id !!}" @if($tenderInfo->tender_cat_id==$sc->id) selected @endif>{!! $sc->name !!}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group"><label class="control-label" for="stall_id">Organization:<span class="text-danger">*</span></label>
                                    <select class="form-control selectpicker" name="nsd_id" id="nsd_id"  data-live-search="true">
                                        ...
                                        @foreach($nsdNames as $nn)
                                            <option value="{!! $nn->id !!}" @if($tenderInfo->nsd_id==$nn->id) selected @endif>{!! $nn->name !!}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group"><label class="control-label" for="invitation_for">Invitation For:<span class="text-danger">*</span></label>
                                    <select class="form-control selectpicker" name="invitation_for" id="invitation_for">
                                        <option value="">{!! 'Select' !!}</option>
                                        <option value="Purchase of Goods" @if($tenderInfo->invitation_for=='Purchase of Goods') selected @endif >{!! 'Purchase of Goods' !!}</option>
                                        <option value="Repair & Upgradation" @if($tenderInfo->invitation_for=='Repair & Upgradation') selected @endif>{!! 'Repair & Upgradation' !!}</option>
                                        <option value="Maintenance" @if($tenderInfo->invitation_for=='Maintenance') selected @endif>{!! 'Maintenance' !!}</option>
                                        <option value="Overhauling" @if($tenderInfo->invitation_for=='Overhauling') selected @endif>{!! 'Overhauling' !!}</option>
                                        <option value="Exchange" @if($tenderInfo->invitation_for=='Exchange') selected @endif>{!! 'Exchange' !!}</option>
                                        <option value="Repair" @if($tenderInfo->invitation_for=='Repair') selected @endif>{!! 'Repair' !!}</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <!-- <div class="col-md-4">
                                <div class="form-group"><label class="control-label" for="date">Date :<span class="text-danger">*</span></label>
                                    {!!  Form::text('date', $demandToLprInfo->when_needed, array('id'=> 'date', 'class' => 'form-control datapicker2','readonly')) !!}
                                </div>
                            </div> -->

                            <div class="col-md-4">
                                <div class="form-group"><label class="control-label " for="development_partners">Development Partners (If Applicable) :</label>
                                    {!!  Form::text('development_partners', old('development_partners',$tenderInfo->development_partners), array('id'=> 'development_partners', 'class' => 'form-control')) !!}
                                </div>
                            </div>

                            <div class="col-md-4">
                                <div class="form-group"><label class="control-label " for="proj_prog_code">Project/Programme Code (If Applicable) :</label>
                                    {!!  Form::text('proj_prog_code', old('proj_prog_code',$tenderInfo->proj_prog_code), array('id'=> 'proj_prog_code', 'class' => 'form-control')) !!}
                                </div>
                            </div>

                            <div class="col-md-4">
                                <div class="form-group"><label class="control-label " for="tender_package_no">Tender Package No :</label>
                                    {!!  Form::text('tender_package_no', old('tender_package_no',$tenderInfo->tender_package_no), array('id'=> 'tender_package_no', 'class' => 'form-control')) !!}
                                </div>
                            </div>

                            <div class="col-md-4">
                                <div class="form-group"><label class="control-label " for="tender_package_name">Tender Package Name :</label>
                                    {!!  Form::text('tender_package_name', old('tender_package_name',$tenderInfo->tender_package_no), array('id'=> 'tender_package_name', 'class' => 'form-control')) !!}
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group"><label class="control-label " for="pre_tender_meeting">Place/Date/Time of pre-tender meeting :</label>
                                    {!!  Form::text('pre_tender_meeting', old('pre_tender_meeting',$tenderInfo->pre_tender_meeting), array('id'=> 'pre_tender_meeting', 'class' => 'form-control pre_tender_meeting')) !!}
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 hidden">
                                <div class="form-group"><label class="control-label" for="eligibility_of_tender">Eligibility of Tender :</label>
                                    <select class="form-control selectpicker" name="eligibility_of_tender" id="eligibility_of_tender">
                                        <option value="">Select</option>
                                        <option value="NSSD Enlisted Firm" @if($tenderInfo->eligibility_of_tender=='NSSD Enlisted Firm') selected @endif>{!! 'NSSD Enlisted Firm' !!}</option>
                                        <option value="NSSD Enlisted & Unlisted Firm" @if($tenderInfo->eligibility_of_tender=='NSSD Enlisted & Unlisted Firm') selected @endif>{!! 'NSSD Enlisted & Unlisted Firm' !!}</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group"><label class="control-label " for="name_of_offi_invit_ten">Name of Official Inviting Tender :</label>
                                    {!!  Form::text('name_of_offi_invit_ten', old('name_of_offi_invit_ten',$tenderInfo->name_of_offi_invit_ten), array('id'=> 'name_of_offi_invit_ten', 'class' => 'form-control')) !!}
                                </div>
                            </div>

                            <div class="col-md-4">
                                <div class="form-group"><label class="control-label " for="desg_of_offi_invit_ten">Designation of Official Inviting Tender :</label>
                                    {!!  Form::text('desg_of_offi_invit_ten', old('desg_of_offi_invit_ten',$tenderInfo->desg_of_offi_invit_ten), array('id'=> 'desg_of_offi_invit_ten', 'class' => 'form-control')) !!}
                                </div>
                            </div>

                            <div class="col-md-4">
                                <div class="form-group"><label class="control-label " for="nhq_ltr_no">Reference Number :<span class="text-danger">*</span></label>
                                    {!!  Form::text('nhq_ltr_no', old('nhq_ltr_no',$tenderInfo->nhq_ltr_no), array('id'=> 'nhq_ltr_no', 'class' => 'form-control')) !!}
                                </div>
                            </div>

                            <div class="col-md-4">
                                <div class="form-group"><label class="control-label" for="reference_date">Reference Date:</label>
                                    {!!  Form::text('reference_date', old('reference_date', (!empty($tenderInfo->reference_date)) ? date('Y-m-d',strtotime($tenderInfo->reference_date)) : date('Y-m-d') ), array('id'=> 'reference_date', 'class' => 'form-control datapicker2', 'readonly')) !!}
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group"><label class="control-label" for="delivery_date">Delivery time after issue of w/order:<span class="text-danger">*</span></label>
                                    {!!  Form::text('delivery_date', old('delivery_date',$tenderInfo->delivery_date), array('id'=> 'delivery_date', 'class' => 'form-control', 'required')) !!}
                                </div>
                            </div>

                            <div class="col-md-4">
                                <div class="form-group"><label class="control-label" for="delivery_date">Location:<span class="text-danger">*</span></label>
                                    {!!  Form::text('location', old('location',$tenderInfo->location), array('id'=> 'location', 'class' => 'form-control', 'required')) !!}
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-4">
                                        <div class="form-group"><label class="control-label" for="stall_id">Brief Description of Goods :</label>
                                            {!!  Form::textarea('tender_description', old('tender_description',$tenderInfo->tender_description), array('id'=> 'tender_description', 'rows' => '3', 'class' => 'form-control')) !!}
                                        </div>
                                    </div>

                                    <div class="col-md-4 hidden">
                                        <div class="form-group"><label class="control-label" for="stall_id">Letter Body :</label>
                                            {!!  Form::textarea('letter_body', old('letter_body',$tenderInfo->letter_body), array('id'=> 'letter_body', 'rows' => '3', 'class' => 'form-control')) !!}
                                        </div>
                                    </div>

                                    <div class="col-md-4">
                                        <div class="form-group"><label class="control-label" for="stall_id">Remarks :</label>
                                            {!!  Form::textarea('remarks', old('remarks',$tenderInfo->remarks), array('id'=> 'remarks', 'rows' => '3', 'class' => 'form-control')) !!}
                                        </div>
                                    </div>

                                    <div class="col-md-4">
                                        <div class="form-group"><label class="control-label" for="additionl_info">Additional Info :</label>
                                            {!!  Form::textarea('additionl_info', old('additionl_info',$tenderInfo->additionl_info), array('id'=> 'additionl_info', 'rows' => '3', 'class' => 'form-control')) !!}
                                        </div>
                                    </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-group" style="margin-bottom: 0px;"><label class="control-label" for="status" style="display: none;"></label>
                                                        <div class="checkbox checkbox-success" style="margin-bottom: 0px; margin-top: 0px;">
                                                            <input class="activity_1 activitycell" type="checkbox" id="item_to_tender_assing{!! $itdmap->id !!}" name="item_to_tender_assing[]" value="{!! $itdmap->id !!}" required="" checked="">
                                                ...
                                                <td>
                                                    <div class="form-group" style="margin-bottom: 0px !important;">
                                                        <input type="text" class="form-control unit" id="" name="unit[]" value="@if(!empty($itdmap->nhq_app_qty)) {!! $itdmap->nhq_app_qty !!} @else {!! $itdmap->unit !!} @endif" placeholder="" required="">
                                                    </div>
                                                </td>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group"><label class="control-label" for="terms_conditions_field">Terms & Conditions :</label>
                                            {!!  Form::textarea('terms_conditions_field', old('terms_conditions_field',$tenderInfo->tender_terms_conditions), array('id'=> 'terms_conditions_field', 'rows' => '3', 'class' => 'form-control')) !!}
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group"><label class="control-label" for="status">Status :<span class="text-danger">*</span></label>
                                    {{ Form::select('status', array('1' => 'Published', '2' => 'Unpublished'), old('status',$tenderInfo->status_id), array('class' => 'form-control selectpicker', 'id' => 'status')) }}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-11 col-sm-offset-1">
                                    ...
                                    <button type="submit" class="btn btn-primary pull-right" id="submitButton">{!! 'Submit Tender' !!}</button>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            var countChecked = 0;
            var lotNaAsignFiels = 0;
            $("form").submit(function(){
                countChecked = 0;
                lotNaAsignFiels = 0;
                if(natr_type==2){
                    $(".activity_1").each(function(){
                        // if($(this).is(":not(:checked)")){
                        //     alert("Creat lot by all the checkbox");
                    ...
                    $(".lot_name_class").each(function(){
                        if($(this).val().length > 0){
                            lotNaAsignFiels++;
                        }
                    });

                    if(lotNaAsignFiels != countChecked){
                        alert('Please create lot name');
                        $("#submitButton").removeAttr('disabled');
                        e.preventDefault();
                    }
