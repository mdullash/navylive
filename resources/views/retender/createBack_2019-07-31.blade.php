            ...
            <div class="col-sm-6 col-md-12">
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        ...
                        <input type="hidden" name="demandId" value="{!! $demand_id !!}">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-group" style="margin-bottom: 0px;"><label class="control-label" for="status" style="display: none;"></label>
                                                        <div class="checkbox checkbox-success" style="margin-bottom: 0px; margin-top: 0px;">
                                                            <input class="activity_1 activitycell" type="checkbox" id="item_to_tender_assing{!! $itdmap->id !!}" name="item_to_tender_assing[]" value="{!! $itdmap->id !!}" required="">
                                                ...
                                                <td>
                                                    <div class="form-group" style="margin-bottom: 0px !important;">
                                                        <input type="text" class="form-control unit" id="" name="unit[]" value="{!! $itdmap->nhq_app_qty !!}" placeholder="" readonly="" required="">
                                                    </div>
                                                </td>
