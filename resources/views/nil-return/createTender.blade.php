        ...
        <div class="row">
            <div class="col-sm-6 col-md-12">
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        {{ Form::open(array('role' => 'form', 'url' => 'nil-return-create-tender-post', 'files'=> true, 'class' => 'tender', 'id'=>'tender')) }}
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group" style="margin-bottom: 0px !important;">
                                                        <input type="text" class="form-control unit" id="" name="unit[]" value="{!! $itdmap->nhq_app_qty !!}" placeholder="" required="">
                                                    </div>
                                                </td>
