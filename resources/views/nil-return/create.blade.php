                    ...
                    <div class="panel-body">
                        ...
                        <input type="hidden" name="nil_id" value="{!! $nilId !!}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {!!  Form::text('nil_date', old('nil_date'), array('id'=> 'nil_date', 'class' => 'form-control datapicker2','readonly')) !!}
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!!  Form::text('nil_number', old('nil_number',$nilReturn->tender_number), array('id'=> 'nil_number', 'class' => 'form-control','required')) !!}
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="requester" style="display: none;">Ext:<span class="text-danger"></span></label>
