        ...
        <div class="hpanel">
            <div class="panel-body">
                <h2 class="font-light m-b-xs">
                    <h3>Quarterly performance evaluation</h3>
                </h2>
            </div>
                ...
                <div class="hpanel">
                    <div class="panel-heading hbuilt">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                {{ Form::open(array('role' => 'form', 'url' => 'evaluated-tender-quaterly', 'files'=> true, 'method'=>'get', 'class' => 'form-horizontal', 'id'=>'schedule-all')) }}
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <label for="email">Select Quarterly: </label>
                                            <select class="form-control selectpicker" name="quater" id="quater">
                                                <option value="">{!! '- Select -' !!}</option>

                                                <option value="1" @if($quater==1) selected @endif>{!! 'January - March' !!}</option>
                                                <option value="2" @if($quater==2) selected @endif>{!! 'April - June' !!}</option>
                                                <option value="3" @if($quater==3) selected @endif>{!! 'July - September' !!}</option>
                                                <option value="4" @if($quater==4) selected @endif>{!! 'October - December' !!}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
