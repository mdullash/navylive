        ...
        <div class="row">
            <div class="col-sm-6 col-md-12">
                <div class="hpanel">
                    ...
                    ?>
                    <div class="panel-body">
                        {{ Form::open(array('role' => 'form', 'url' => '/cst-forwarding/pending-store', 'files'=> true, 'class' => 'tender', 'id'=>'tender')) }}
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!!  Form::text('cst_forwarding_number', old('cst_forwarding_number',$tenderNumber), array('id'=> 'cst_forwarding_number', 'class' => 'form-control','required')) !!}
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea cols="25" rows="5" type="text" name="enclosure" class="form-control" id="enclosure">1.&#09;Quotation&#09;&#09;&#09;&#09;&#09;-1/2/3 (One/Two/Three) Set.&#13;&#10;2.&#09;Comparative Statement (CST)&#09;- 2/4/6 (Two/Four/Six) Pages.&#13;&#10;3.&#09;Invitation For Tender (IFT)&#09;&#09;- 2/3/4 (Two/Three/Four) Pages.
                                </textarea>
                            </div>
                        </div>
