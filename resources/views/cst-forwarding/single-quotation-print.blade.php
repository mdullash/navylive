...
<table style="width: 100%;font-size: 14px;">
    ...
    <tr>
        <td></td>
        <td style="padding-left: 21px;">Email: @if(!empty($approverName)) {{$approverName->email}} @endif</td>
    </tr>
    <tr>
        <td></td>
        <td></td>
...
<p style="line-height: 170%;text-transform: uppercase;text-align: justify;">
    <u>
        FORWARDING OF quotation Local purchase of
...
<p style="text-align: justify;line-height: 170%;margin-top: 30px;">
    ...
    {{ ($qutationTenderCount > 0) ? \functions\OwnLibrary::numberTowords1($qutationTenderCount) : "no"  }} {{$qut}} {{ ($qutationTenderCount > 1) ? "have" : "has"  }} been found.
    @if($NotSelectAsDraftCount > 0)
        ...
        due to {{$NotSelectAsDraftSupplier}} {{ ($NotSelectAsDraftCount > 1) ? "have" : "has"  }} been cancelled due to not fulfilling tender requirements.
    @endif
    @if($qutationTenderCount == 1)
    Single Quotation has been found BDT {{ \functions\OwnLibrary::numberformat($qutationTender->total) }} ({{ ucwords(\functions\OwnLibrary::numberTowords1($qutationTender->total).' Only') }}).
    @endif
</p>

<p style="text-align: justify;line-height: 170%;margin-top: 30px;">2. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    Therefore, {!! ($NotSelectAsDraftSupplier > 0) ? "correct" : "" !!} quotation is forwarded for necessary action.
</p>
