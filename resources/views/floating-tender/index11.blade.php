                ...
                <div class="hpanel">
                    <div class="panel-heading hbuilt">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-info btn-effect-ripple" href="{{ URL::to('tender/create') }}"><i class="fa fa-plus"></i> Add Tender</a>
                        </div>
                        <?php } ?>
                            <h3>Tender</h3>
                    </div>
                        <div class="panel-body">
                            ...
                            <table class="table table-bordered table-hover table-striped middle-align">
                                ...
                                <tr class="center">
                                    ...
                                    <th class="text-center" width="10%">{{'Tender Title'}}</th>
                                    <th class="text-center">{{'Tender Number'}}</th>
                                    <th class="text-center" width="">{{'Tender Opening Date'}}</th>
                                    <th class="text-center" width="">{{'Tender Category'}}</th>
                                ...
                                @if (!$tenders->isEmpty())
                                    ...
                                    @foreach($tenders as $sc)
                                        <tr>
                                            ...
                                            <td>
                                                @if($sc->tender_type == 1) {!! 'Tender' !!}  
                                                @elseif($sc->tender_type == 2) {!! 'Retender' !!}  
                                                @elseif($sc->tender_type == 3) {!! 'Standard' !!}  
                                                @endif
                                            </td>
                                            <td>
                                                @if($sc->tender_priority == 1) {!! 'Urgent' !!}  
                                                @elseif($sc->tender_priority == 2) {!! 'Normal' !!}  
                                                @elseif($sc->tender_priority == 3) {!! 'Low' !!}  
                                                @endif
                                            </td>
                                            <td>
                                                @if($sc->tender_nature == 1) {!! 'Individual' !!}  
                                                @elseif($sc->tender_nature == 2) {!! 'Packing' !!}   
                                                @endif
                                            </td>
