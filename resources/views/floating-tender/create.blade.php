            ...
            <div class="col-sm-6 col-md-12">
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        ...
                        <input type="hidden" name="demandToLprId" value="{!! $id !!}">
                            ...
                            <?php
                                 $requeName = \App\DemandeName::where('id','=',$demandToLprInfo->requester)->value('name');
                            ?>

                            <div class="col-md-4">
	                            <div class="form-group"><label class="control-label" for="demending">Demanding/User:<span class="text-danger">*</span></label>
	                                {!!  Form::text('demending', $requeName, array('id'=> 'demending', 'class' => 'form-control','required')) !!}
	                            </div>
                        	</div>
