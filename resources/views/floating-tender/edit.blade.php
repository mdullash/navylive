            ...
            <div class="col-sm-6 col-md-12">
                <div class="hpanel">
                    ...
                    {{ Form::model($editId, array('route' => array('tender.update', $editId->id), 'method' => 'PUT', 'files'=> true, 'class' => 'form validate-form tender', 'id' => 'tender')) }}
                            ...
                            <div class="col-md-4">
                                <div class="form-group"><label class="control-label" for="stall_id">Reference Tender Number :<span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group"><label class="control-label " for="valid_date_from">Valid Date From :<span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group"><label class="control-label" for="tender_type">Tender Type :<span class="text-danger">*</span></label>
                                    {{ Form::select('tender_type', array('' => '- Select -', '1' => 'Tender', '2' => 'Retender', '3' => 'Standard'), old('tender_type'), array('class' => 'form-control selectpicker', 'id' => 'tender_type')) }}
                                </div>
                            </div>

                            <div class="col-md-4">
                                <div class="form-group"><label class="control-label" for="tender_priority">Tender Priority :<span class="text-danger">*</span></label>
                                    {{ Form::select('tender_priority', array('' => '- Select -', '1' => 'Urgent', '2' => 'Normal', '3' => 'Low'), old('tender_priority'), array('class' => 'form-control selectpicker', 'id' => 'tender_priority')) }}
                                </div>
                            </div>

                            <div class="col-md-4">
                                <div class="form-group"><label class="control-label" for="tender_nature">Tender Nature :<span class="text-danger">*</span></label>
                                    {{ Form::select('tender_nature', array('' => '- Select -', '1' => 'Individual', '2' => 'Packing'), old('tender_nature'), array('class' => 'form-control selectpicker', 'id' => 'tender_nature')) }}
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group"><label class="control-label" for="stall_id">Specification PDF :</label>
                                    {!!  Form::file('specification', array('id'=> 'specification', 'class' => 'form-control', 'accept' => '.pdf')) !!}
                                </div>
                            </div>
