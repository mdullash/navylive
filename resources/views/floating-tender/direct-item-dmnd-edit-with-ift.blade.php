            ...
            <div class="col-sm-6 col-md-12">
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        ...
                        {{ Form::model($editId, array('url' => 'post-direct-item-dmnd-edit-with-ift/'.$editId->id, 'method' => 'PUT', 'files'=> true, 'class' => 'tender', 'id' => 'tender')) }}
                        <!-- Tender area ============================================
                        ============================================================= -->
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group" style="margin-bottom: 0px !important;">
                                                        <input type="number" class="form-control unit" id="" name="unit[]" value="{!! $itdmap->unit !!}" placeholder="" required="">
                                                    </div>
                                                </td>
