...
<body style="background: url({{asset('/public/img/dashboard_bg.jpg')}}) no-repeat center center !important; background-size: 100% 100% !important;">

<?php
$quizBook=\App\Settings::find(1);

?>
<!-- <div class="splash"> <div class="color-line"></div><div class="splash-title"><img src="{!! asset($quizBook->logo) !!}" class="rotating123" width="64" height="64" /><h1 class="mm-group-text"><b>{!! $quizBook->site_title !!}</b></h1><p></p> </div> </div>
 -->
    ...
    <div class="content animate-panel">
        <div class="row">
            <div class="{--col-md-offset-1--} col-md-10 col-xs-12">
                ...
                @foreach($zones as $zn)
                    <div class="col-md-4 ">
                        <a href="{{URL::to('dashboard/'.base64_encode($zn->id))}}">
                            <div class="hpanel dashboard-box" style="background-image: url({{asset('/public/img/'.$zn->icon)}}); background-repeat: no-repeat; background-size: 100%;">
                                <div class="panel-body file-body" style="background: none;">
                                    <div class="row">
                                        <div class="col-md-5 col-sm-6 col-xs-6">
                                            <br><br><br><br>
                                            {{--<i class="{!! $zn->icon !!}" aria-hidden="true" style="color: #FFFFFF"></i><br>--}}
                                            {{--<img class="img-circle m-b" width="76" height="76" src="{{URL::to('/')}}/public/img/bsd.png">--}}
                                        </div>
                                        <div class="col-md-7 col-sm-6 col-xs-6">
                                            {{--<span style="text-align: center; color: #FFFFFF"><b>{!! $zn->name !!}</b></span>--}}
                                        </div>
                                    </div>
                                </div>
