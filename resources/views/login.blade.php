...
<html>
    ...
    <body class="blank" style="background: url({{asset('/public/img/admin_bg.jpg')}}) no-repeat center center !important; background-size: 100% 100% !important;">

        <!-- Loading Transition  -->
        <div id="spinningSquaresG1">
            <div class="loader-title position-relative d-flex justify-content-center align-items-end">
                <img src="{!! asset($quizBook->logo) !!}" class="" width="64" height="64">
            </div>
        ...
        <div class="login-container l-panel">
            <div class="row">
                <div class="col-md-12 text-center login-logo">
                    <img src="{!! asset($quizBook->logo) !!}" width="" height="120" />
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
