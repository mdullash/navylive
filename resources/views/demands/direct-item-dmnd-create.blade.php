            ...
            <div class="col-sm-6 col-md-12">
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        ...
                        {{ Form::open(array('role' => 'form', 'url' => 'post-direct-item-dmnd', 'files'=> true, 'class' => 'tender', 'id'=>'tender')) }}
                            ...
                            <div class="form-group"><label class="control-label" for="stall_id">Organization:<span class="text-danger">*</span></label>
                                <select class="form-control selectpicker" name="nsd_id" id="nsd_id"  data-live-search="true">
                                    ...
                                    @foreach($nsdNames as $nn)
                                        <option value="{!! $nn->id !!}" @if($nn->default_selected==1) selected @endif>{!! $nn->name !!}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <!-- <div class="col-md-4">
                            <div class="form-group"><label class="control-label" for="date">Date :<span class="text-danger">*</span></label>
                                {!!  Form::text('date', date('Y-m-d'), array('id'=> 'date', 'class' => 'form-control datapicker2','readonly')) !!}
                            </div>
                        </div> -->
                        ...
                        <div class="col-md-4">
                            <div class="form-group"><label class="control-label" for="demending">Demanding/User:<span class="text-danger">*</span></label>
                                {!!  Form::text('demending', old('demending'), array('id'=> 'demending', 'class' => 'form-control','required')) !!}
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <!-- Start Item area ==========================================
    ===========================================================-->
                            <div class="row hidden" id="lotItemNameField" style="padding-top: 15px;">
                                <div class="col-md-12">
                                    <div class="form-group col-md-4"><label class="control-label " for="parent_lot_name">Lot Item Name :</label>
                                        {!!  Form::text('parent_lot_name', '', array('id'=> 'parent_lot_name', 'class' => 'form-control parent_lot_name')) !!}
                                        <p id="errorText"></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 remove appendRewRow firstRow" id="firstRow" {{--style="border: 1px solid black; padding: 5px;"--}}>
                                ...
                                <div class="col-md-1 hidden checkForHideShow" style="width: 2% !important; padding-left: 0px;">
                                    <div class="form-group " style=""><label class="control-label" for="status" style="display: none;"></label>
                                        <div class="checkbox checkbox-success" style="margin-top: 30px;">
                                            <input class="activity_1 activitycell" type="checkbox" id="item_to_tender_assing1" name="item_to_tender_assing[]" value="">
                                            <label for="item_to_tender_assing1"></label>
                                        </div>
                                    </div>
                                </div>

                                <div class="col-md-2"style="width: 23% !important;">
                                    <div class="form-group">
                                        <label for="machinery_and_manufacturer">Item Name: <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control search_item_name" id="machinery_and_manufacturer" name="machinery_and_manufacturer[]" placeholder="Search...." autocomplete="off" required>
                                        <input type="hidden" class="form-control item_id" id="" name="machinery_and_manufacturer_id[]" placeholder="" >
                                    </div>
                                ...
                                <!-- <div class="col-md-1" style="width: 2% !important; padding-left: 0px;">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control unit" id="unit" name="unit[]" step="any" placeholder="Quantity" min="0" >
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control unit_price" id="price" name="price[]" placeholder="Estimated Price" min="0" >
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control sutotal_price" id="sutotal_price" name="sutotal_price[]" placeholder="Estimated Subtotal" min="0" readonly>
                                    </div>
                                </div>

                                <div class="col-md-2 hidden">
                                    <div class="form-group">
                                        <label for="sutotal_price">Lot Name</label>
                            ...
                            <div class="col-md-12">
                                <div class="hidden" id="createLotButton">
                                    <div class="col-md-3">
                                        <div class="form-group">
        ...
        $(document).ready(function(){
            ...
            $(document).on('mouseover','.firstRow',function(){
                ...
                if(natr_type==2){
                    ...
                    $(".checkForHideShow").removeClass('hidden');
                    $("#lotItemNameField").removeClass('hidden');
                }else{
                    $("#createLotButton").addClass('hidden');
                    $(".checkForHideShow").addClass('hidden');
                    $("#lotItemNameField").addClass('hidden');
                }
            ...
            $("#parent_lot_name").val('Lot '+inWords(1));
            var numberToWord = 1;
            ...
            $(document).on('click','#createLotButton',function(){
                $('input:checkbox.activitycell').each(function () {
                    if(this.checked){
                        ...
                        if(preLotNameVal == ''){
                            ...
                            var lotNameInWord = $("#parent_lot_name").val();
                ...
                if(newlyCheckedOrNot==1){
                    bootbox.alert("Lot Name: "+$("#parent_lot_name").val(), function (result) {});
                    numberToWord++;
                    newlyCheckedOrNot = 0;
                    $("#parent_lot_name").val('Lot '+inWords(numberToWord));
                }
