            ...
            <div class="col-sm-6 col-md-12">
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        ...
                        <input type="hidden" name="updateFilelds" value="{!! $upd !!}">
                            
                            <div class="col-md-4"></div>
                            <div class="col-md-4">
                                <div class="form-group"><label class="control-label" for="status">Status :<span class="text-danger">*</span></label>
                                    {{ Form::select('demand_approval', array('' => 'Select', '1' => 'Approved', '2' =>'Reject'), '', array('class' => 'form-control selectpicker', 'id' => 'demand_approval','required')) }}
                                </div>
                            </div> 
