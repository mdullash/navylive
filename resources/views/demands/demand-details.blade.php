                                    ...
                                    @if (!empty($demand))
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php 
                                                    $remComma = 1;
                                                    $num_of_items = count($demand->itemsToDemand);         
                                                ?>
                                                @if(!empty($demand->itemsToDemand) && count($demand->itemsToDemand) > 0)
                                                    @foreach($demand->itemsToDemand as $ke => $itmsf)
                                                        {!! $itmsf->item_name !!}
                                        ...
                                        @foreach($itemtodemand as $itdm)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php } elseif(!empty($itdm->lp_section_status) && $itdm->lp_section_status ==2 && !empty($itdm->head_ofc_apvl_status) && $itdm->nhq_app_status == 3 && $itdm->current_status == 10){ ?>
                                                        <span class=" btn-warning btn-xs"> {!! "Reject By Headquarter" !!}</span>
                                                    <?php } elseif(!empty($itdm->lp_section_status) && $itdm->lp_section_status ==2 && !empty($itdm->head_ofc_apvl_status) && $itdm->nhq_app_status == 2 && $itdm->current_status == 10){ ?>
                                                        <span class=" btn-warning btn-xs"> {!! "Retender" !!}</span>    
                                                    <?php } elseif( (!empty($itdm->cst_supplier_select) || $itdm->head_ofc_apvl_status ==1 ) && $itdm->lp_section_status ==1 && empty($itdm->po_status) && ($itdm->current_status == 9 || $itdm->current_status == 10) ){ ?>
                                                        <span class=" btn-warning btn-xs"> {!! "Generate PO" !!}</span>
                                                    <?php } elseif(!empty($itdm->po_status) && empty($itdm->po_check_status) && $itdm->current_status == 11 ){ ?>
                                                        <span class=" btn-warning btn-xs"> {!! "Waiting for PO checking" !!}</span>
                                                    <?php } elseif(!empty($itdm->po_check_status) && empty($itdm->po_approve_status) && $itdm->po_check_status==1 && $itdm->current_status == 11 ){ ?>
                                                        <span class=" btn-success btn-xs"> {!! "Waiting for PO approve" !!}</span>
                                                    <?php } elseif(!empty($itdm->po_check_status) && empty($itdm->po_approve_status) && $itdm->po_check_status==2 && $itdm->current_status == 11 ){ ?>
                                                        <span class=" btn-warning btn-xs"> {!! "Po rejected from check" !!}</span>
                                                    <?php } elseif(!empty($itdm->po_approve_status) && empty($itdm->cr_status) && $itdm->po_approve_status==2 && $itdm->current_status == 11 ){ ?>
                                                        <span class=" btn-warning btn-xs"> {!! "Po rejected" !!}</span>
                                                    <?php } elseif(!empty($itdm->po_approve_status) && $itdm->po_approve_status==1 && empty($itdm->cr_status) && $itdm->current_status == 11 ){ ?>
