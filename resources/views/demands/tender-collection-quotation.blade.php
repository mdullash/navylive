                            ...
                            <?php $sl = 0; ?>
                                ...
                                <div class="col-md-12 remove appendRewRow firstRow">
                                            ...
                                            <div class="col-md-12 supplierUnderRows">
                                                ...
                                                <div class="col-md-1">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control quoted_quantity forNumberIconPadding" id="quoted_quantity" name="quoted_quantity[0][]" value="{!! $itn->unit !!}" min="0"">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control sample_qty" id="sample_qty" name="sample_qty[0][]" min="0" step="any">
                                                    </div>
                                                </div>
                                    ...
                                    @endif        
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="comnt_on_col_qut_supplier">Comment:</label>
                                                <textarea class="form-control" name="comnt_on_col_qut_supplier[0][]" rows="1"></textarea>
                                            </div>
                                        </div>
