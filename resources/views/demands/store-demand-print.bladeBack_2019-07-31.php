    ...
    <form action="#">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td colspan="4"><p><span>৪। </span>চাহিদা নং:
            ...
            <tr>
                ...
                <td colspan="3"><p><span>৬। </span>কবে নগদ দরকার:</p></td>
            </tr><!--/tr-->
            ...
            <tr>
                            ...
                            @foreach($demands->itemsToDemand as $ke => $itmsf)
                                ...
                                @endif
                                    <div class="defaulterArea">
                                        <div class="form-group">
                                            <label class="radio_container col-md-12"> <input type="radio" name="radio" @if($item_patt->item_type == 1) checked="checked" @endif> স্থায়ী সামগ্রী

                                            </label>
                                        </div><!--form-group-->
                                        <div class="form-group">
                                            <label class="radio_container col-md-12"> <input type="radio" name="radio" @if($item_patt->item_type == 3) checked="checked" @endif> প্রায় স্থায়ী সামগ্রী

                                            </label>
                                        </div><!--form-group-->
                                        <div class="form-group">
                                            <label class="radio_container col-md-12"><input type="radio" name="radio" @if($item_patt->item_type == 2) checked="checked" @endif> ক্ষয়যোগ্য সামগ্রী
                ...
                <td rowspan="3" colspan="1" class="colNine">
                    ...
                    <p>
                        @if(!empty($demands->when_needed))
                        {{date('d-m-Y',strtotime($demands->when_needed))}}
                            @endif
                    </p>
                </td>
                <td rowspan="3" colspan="3">
                        ...
                        <div class="signatureArea">
                            <div class="diclarationBtm d-flex"> <!--diclarationBtm-->
                                <div class="sigDate" style="width: 50%;">
                                    <p>অথরিটি নাম্বার: @if(!empty($demands->pattern_or_stock_no))
                                            {{$demands->pattern_or_stock_no}}
                                        @endif </p><Span class="dashed-border"></Span>
                                </div>
                            </div>
                            <div class="signature">
                                <div class="d-flex">
                            ...
                            <div class="diclarationBtm d-flex"> <!--diclarationBtm-->
                                <div class="sigDate" style="width: 50%;">
                                    <p>তারিখ: @if(!empty($demands->reference_date))
                                            {{date('d-m-Y',strtotime($demands->reference_date))}}
                                        @endif </p><Span class="dashed-border"></Span>
                                </div>
