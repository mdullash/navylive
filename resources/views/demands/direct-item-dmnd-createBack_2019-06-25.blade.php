            ...
            <div class="col-sm-6 col-md-12">
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-12 remove appendRewRow firstRow" id="firstRow" {{--style="border: 1px solid black; padding: 5px;"--}} style="padding-top: 15px;">
                            ...
                            <div class="col-md-2"style="width: 23% !important;">
                                <div class="form-group">
                                    <label for="machinery_and_manufacturer">Machinery/Manufact./Item: <span class="text-danger">*</span></label>
