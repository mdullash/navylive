                    ...
                    <div class="panel-body">
                        ...
                        {{ Form::open(array('role' => 'form', 'url' => 'demand', 'files'=> true, 'class' => '', 'id'=>'demands')) }}
                            ...
                            <div class="col-md-12" {{--style="border: 1px solid black; padding: 5px;"--}}>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="pattern_or_stock_no">7. Authority<!-- Patt/Part Number --><span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control datapicker2" id="reference_date" name="reference_date" value="{!! old('reference_date',date('Y-m-d')) !!}" placeholder="Reference Date" autocomplete="off" readonly="">
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12 remove appendRewRow firstRow" id="firstRow" {{--style="border: 1px solid black; padding: 5px;"--}}>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="any" class="form-control unit" id="unit" name="unit[]" placeholder="Quantity" min="0" required>
                                </div>
                            </div>
