...
<div class="container my-5">
    ...
    <form action="#">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                <td colspan="4">
                    <p><span>৭। </span> অধিনায়ক অফিসার, নৌ-সামগ্রী ভাণ্ডার, চট্রগ্রাম: {{$demands->for_whom}}</p>
                </td>
            ...
            <!--tr-->
            <tr>
                <td colspan="4"><p><span>১২। </span> কার জন্য/ কার প্রয়োজনে রণতরী বা ঘাঁটির নামকরণ</p></td>
            </tr><!--/tr-->

            <!--tr-->
            <tr>
                <td colspan="2"><p><span>১৩। </span>সামগ্রীর প্রান্তিক সনাক্তকরন</p></td>
                <td colspan="2"><p><span>(ক)</span> যন্ত্রপাতি এবং প্রস্তুতকারক</p></td>
                <td colspan="2"><p><span>(খ)</span> মডেল/টাইপ/মার্ক</p></td>
                <td colspan="2"><p><span>(গ)</span> ক্রমিক নং/রেজিঃ নং</p></td>
                <td colspan="3"><p><span>(ঘ)</span> প্রকাশন/শ্রেণী বিন্যাস</p></td>
            </tr><!--/tr-->
