                    ...
                    <div class="panel-heading hbuilt">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            ?>
                                ...
                                @if($demandDetailPageFromRoute=='group-check-acc')
                                    <li @if($demandDetailPageFromRoute=='group-check-acc' && $segTwo==1)class="active" @endif><a href="{{URL::to('group-check-acc/1')}}"> Pending</a></li>
                                ...
                                @if($demandDetailPageFromRoute=='floating-tender-acc')
                                    ...
                                    <li @if($demandDetailPageFromRoute=='floating-tender-acc' && $segTwo==3)class="active" @endif><a href="{{URL::to('floating-tender-acc/3')}}"> Authorised Approval</a></li>
                                    <?php } ?> 
                                @endif
                                ...
                                @if($demandDetailPageFromRoute=='collection-quotation-acc')
                                    ...
                                    <li @if($demandDetailPageFromRoute=='collection-quotation-acc' && $segTwo==3)class="active" @endif><a href="{{URL::to('collection-quotation-acc/3')}}"> Authorised Approval</a></li>
                                    <?php } ?> 
                                @endif
