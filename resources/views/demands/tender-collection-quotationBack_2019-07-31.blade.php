                                            ...
                                            <div class="col-md-12 supplierUnderRows">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control unit_price" id="unit_price" name="unit_price[0][]" value="" min="0" >
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control total_price" id="total_price" name="total_price[0][]" value="" min="0" readonly="" required>
                                                    </div>
                                                </div>
                                    ...
                                    @endif        
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control total_quantity" id="total_quantity" name="total_quantity[0][]" value="{!! $totalQty !!}" min="0" readonly="" required>
                                            </div>
                                        </div> 
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control total" id="total" name="total[0][]" value="0" min="0" readonly="" required>
                                            </div>
                                        </div>
