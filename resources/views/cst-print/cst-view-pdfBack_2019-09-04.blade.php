                                    ...
                                    @if(!empty($supArray)) 
                                        <tr>
                                            ...
                                            <?php $devideData = explode('?',$sui); ?>
                                                <td @if(empty($devideData[2])) colspan="{!! $colSpanWithOutAlt !!}" @else colspan="{!! $colSpanWithAlt !!}" class="text-center" @endif style="text-align: center;border-bottom: 1px solid white;">
                                                    {!! $devideData[0] !!}
                                                </td>
                                            @endforeach
                                        </tr>
