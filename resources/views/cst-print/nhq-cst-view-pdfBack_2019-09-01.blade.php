            ...
            <div class="col-lg-12">
                <div class="hpanel">
                    <div class="panel-heading hbuilt">
                            <h3 class="text-center">@if(!empty($supplierResult)) @if($supplierResult[0]->total > $orgInfo->purchase_limit) PRELIMINARY @endif @endif COMPARATIVE STATEMENT- NSSD DHAKA</h3>
                                ...
                                <tr class="center">
                                    ...
                                    @if(!empty($supplierResult))
                                        @foreach($supplierResult->slice($startRange, $endRange) as $sr)
                                            <th class="text-center" colspan="@if(empty($sr->alternative_total)) 2 @else 4 @endif">{!! OwnLibrary::numToOrdinalWord(++$sls) .' Lowest'!!}</th>
                                        @endforeach
                                    @endif
                                        ...
                                        @foreach($targetArray as $ta)
                                            <tr>
                                                @foreach($ta['items'] as $itm)
                                                    ...
                                                    <td style="text-align:left; @if($xyz>1) color: white; border: 1px solid white !important; @endif">{!! $itm->item_name !!}</td>
                                                    ...
                                                    <td style=" @if($xyz>1) color: white; border: 1px solid white !important; @endif">
                                                        {!! empty($itm->nhq_app_qty) ? $itm->unit : $itm->nhq_app_qty !!}
                                                    </td>
                                                    <td style=" @if($xyz>1) color: white; border: 1px solid white !important; @endif">
