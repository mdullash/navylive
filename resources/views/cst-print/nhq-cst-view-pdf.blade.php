...
<body class="printable-page">
    ...
    <htmlpageheader name="page-header">
        <div class="panel-heading hbuilt">
                <h3 class="text-center">@if(!empty($supplierResult)) @if($supplierResult[0]->total > $orgInfo->purchase_limit) PRELIMINARY @endif @endif COMPARATIVE STATEMENT- {!! $orgInfo->name !!}</h3>
