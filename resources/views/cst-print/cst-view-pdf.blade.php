...
<head>
    <meta charset="UTF-8">
<title>
    @if(!empty($supplierResult)) @if($supplierResult[0]->total > $orgInfo->purchase_limit) PRELIMINARY @endif @endif COMPARATIVE STATEMENT- NSSD DHAKA
</title>
                ...
                <div class="hpanel">
                   {{--  <div class="panel-heading hbuilt">
                        ...
                        @while($totalTable >= $xyz)
                           <table style="width: 100%; @if($totalTable>1 && $xyz != $totalTable) margin-bottom: 0 !important; @endif @if($xyz != 1) border-bottom: 1px solid white; border-top: 1px solid white; @endif">
                                <thead>
                                <tr class="center">
                                    ...
                                    <th class="text-center" style="width: 195px;">{{'Last Purchase Info'}}</th>
                                    <?php //$sls = 0; ?>
                                        ...
                                        @foreach($targetArray as $ta)
                                            <tr>
                                                @foreach($ta['items'] as $itm)
                                                    ...
                                                    <td style="">{!! $itm->denoName !!}</td>
                                                    <td style="">{!! $itm->unit !!}</td>
                                                    <td style="">
