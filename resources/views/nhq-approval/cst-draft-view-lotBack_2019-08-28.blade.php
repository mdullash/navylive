                ...
                <div class="hpanel">
                    <div class="panel-heading hbuilt">
                        ...
                        {{ Form::open(array('role' => 'form', 'url' => 'post-headquarte-approval', 'files'=> true, 'class' => '', 'id'=>'')) }}
                            ...
                            <?php $arSlmen = 0; $offerUni = 1; $forlebel=1;?>
                            @if(!empty($mainArray))       
                                                        ...
                                                        <td @if(empty($devideData[2])) colspan="2" @else colspan="4" class="text-center" @endif style="text-align: center;">
                                                            <div class="form-group" style="margin-bottom: 0px;"><label class="control-label" for="status" style="display: none;"></label>
                                                                <div class="checkbox checkbox-success" style="margin-bottom: 0px; margin-top: 0px;">
                                                                    <input class="activity_1 activitycell unique lotwisesupp{!! $devideData[4] !!}" type="checkbox" id="cst_draft_sup_id{!! $devideData[1].'&'.$devideData[4].'&'.$devideData[5] !!}" name="cst_draft_sup_id[]" value="{!! $devideData[1].'&'.$devideData[4].'&'.$devideData[5] !!}" @if($devideData[3]==1) checked @endif>
