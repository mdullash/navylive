                    ...
                    <div class="panel-heading hbuilt">
                        ...
                        {{ Form::open(array('role' => 'form', 'url' => 'post-headquarte-approval', 'files'=> true, 'class' => '', 'id'=>'')) }}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="nhq_ltr_date">NHQ Letter Date:<span class="text-danger">*</span></label>
                                        <input id="nhq_ltr_date" class="form-control datapicker2" readonly required name="nhq_ltr_date" type="text" data-bv-field="nhq_ltr_date" value="{!! $mainTenderInfo->nhq_ltr_date !!}">
                                    </div>
                                </div>
                                            ...
                                            @if(!empty($supArray[$key])) 
                                                <tr style="background-color: #f9f9f9;">
                                                    ...
                                                    <?php $devideData4 = explode('?',$suiii); ?>
                                                        ...
                                                        @else 
                                                            <td colspan="@if($sampelQtyChck>0) 3 @else 2 @endif" style="text-align: center;">
                                                            <div class="form-group" style="margin-bottom: 0px;"><label class="control-label" for="status" style="display: none;"></label>
                                                                <div class="checkbox checkbox-success" style="margin-bottom: 0px; margin-top: 0px;">
                                                            ...
                                                            <!-- Main Offer --></td>
                                                            <?php $forlebel++; ?>
                                                            <td colspan="@if($altSampelQtyChck>0) 3 @else 2 @endif" style="text-align: center;">
                                                            <div class="form-group" style="margin-bottom: 0px;"><label class="control-label" for="status" style="display: none;"></label>
                                                                <div class="checkbox checkbox-success" style="margin-bottom: 0px; margin-top: 0px;">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover table-striped middle-align">
                                            ...
                                            <tr class="center">
                                                ...
                                                <th class="text-center" style="min-width: 100px;">{{'Discount'}}</th>
                                                <th class="text-center" style="min-width: 100px;">{{'Grand Total'}}</th>
                            ...
                            @if($sigMent==1)
                                <div class="col-md-12">
                                    <div class="col-md-2">
                                        {{ Form::open(array('role' => 'form', 'url' => 'retender-reject-from-nhq', 'files'=> true, 'class' => 'retenderForm', 'id'=>'')) }}
                                            <input type="hidden" name="demandToLprId" value="{!! $demandToLprId !!}">
                                            <input type="hidden" name="tenderId" value="{!! $tenderId !!}">
                                            ...
                                            <input type="hidden" name="action" value="2">
                                                <div class="form-group">
                                                    <?php if(!empty(Session::get('acl')[34][21]) ){ ?>
                                                        <button type="submit" class="btn btn-warning" style="margin-right: 5px;">{!! 'Retender All' !!}</button>
                                                    <?php } ?>     
                                                </div>
                                        {!! Form::close() !!}
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        {{ Form::open(array('role' => 'form', 'url' => 'retender-reject-from-nhq', 'files'=> true, 'class' => 'retenderForm', 'id'=>'')) }}
                                            ...
                                            <input type="hidden" name="action" value="3">
                                                <div class="form-group">
                                                    <?php if(!empty(Session::get('acl')[34][21]) ){ ?>
                                                        <button type="submit" class="btn btn-danger" style="margin-right: 5px;">{!! 'Reject All' !!}</button>
                                                    <?php } ?>     
                                                </div>
                                        {!! Form::close() !!}
                                    </div>
