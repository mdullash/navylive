...
@section('content')
        ...
        <div class="row">
            <div class="col-sm-6 col-md-12">
                <div class="hpanel">
                    ...
                    <div class="alert alert-danger fade in alert-dismissible" style="display: none;" id="tender-alert">
                        <a href="#" class="close" data-dismiss="alert" aria-label="close" title="close">×</a>
                        <p>Please, provide the tender number</p>
                    </div>

                    <div class="panel-body">
                        {{ Form::open(array('role' => 'form', 'url' => 'tender-schedule-post', 'files'=> true, 'class' => '', 'id'=>'participent-form')) }}
                            <div class="col-md-6">
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $(document).on('input', '#supplier_reg_no', function() {
                var barCode = $('#supplier_reg_no').val();
                var tenderNumber = $('#tender_number').val();
                if (barCode.length >= 13 && barCode != ""){
                    if(tenderNumber == ''){
                        $('#tender-alert').fadeIn();
                    }else{
                        $('#participent-form').submit();
                    }
                }
            });
