                ...
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        {{ Form::open(array('role' => 'form', 'url' => 'tender-schedule-post', 'files'=> true, 'class' => '', 'id'=>'')) }}
                            ...
                            <div class="col-md-6">
                                <div class="form-group"><label class="control-label" for="stall_id">Supplier ID :<span class="text-danger">*</span></label> 
                                    {!!  Form::text('supplier_reg_no', old('supplier_reg_no'), array('id'=> 'supplier_reg_no', 'class' => 'form-control', 'autocomplete'=>'off')) !!}
