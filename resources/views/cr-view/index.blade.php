                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                {!!  Form::text('po_no', $po_no, array('id'=> 'po_no', 'class' => 'form-control', 'autocomplete'=> 'off')) !!}
                                            </div>
                                        </div>
                                    </div>
                                ...
                                @if (!$demands->isEmpty())
                                    ...
                                    @foreach($demands as $sc)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-success btn-xs" href="{{ URL::to('cr-section/'.$sc->id.'&'.$sc->tender_id.'&'.$segTwo) }}" title="CR view">
                                                    @if($segTwo == 1)
