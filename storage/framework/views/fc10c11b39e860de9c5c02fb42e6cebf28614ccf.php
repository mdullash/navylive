            ...
            <div class="container">
                ...
                <div class="tenderTableArea">
                    ...
                    <table id="tenderTable" class="table table-bordered table-striped table-hover dt-responsive tenderTable" style="width:100%;">
                        ...
                        <?php $__currentLoopData = $recent_tenders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
