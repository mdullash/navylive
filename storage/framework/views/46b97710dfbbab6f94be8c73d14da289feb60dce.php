        ...
        <div class="row">
            <div class="col-sm-6 col-md-12">
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        <?php echo e(Form::open(array('role' => 'form', 'url' => 'manual-tender/store', 'files'=> true, 'class' => 'tender', 'id'=>'tender'))); ?>
                    ...
                    <!--  <div class="col-md-4">
                                <div class="form-group"><label class="control-label" for="stall_id">Demand Number :<span class="text-danger">*</span></label>
                                    <?php echo Form::text('ref_tender_id', old('ref_tender_id'), array('id'=> 'ref_tender_id', 'class' => 'form-control')); ?>
                    ...
                    <!-- <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group"><label class="control-label " for="stall_id">Tender Opening Date :<span class="text-danger">*</span></label>
                                <?php echo Form::text('tender_opening_date', old('date_of_enrollment'), array('id'=> 'tender_opening_date', 'class' => 'form-control datapicker2','readonly')); ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group"><label class="control-label" for="stall_id">Notice PDF :<span class="text-danger">*</span></label>
                                <?php echo Form::file('notice', array('id'=> 'notice', 'class' => 'form-control', 'accept' => '.pdf','required'=>'required')); ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group"><label class="control-label" for="status">Status :<span class="text-danger">*</span></label>
                                <?php echo e(Form::select('status', array('1' => 'Published', '2' => 'Unpublished'), old('status'), array('class' => 'form-control selectpicker', 'id' => 'status'))); ?>
                        ...
                        <div class="form-group">
                            <div class="col-md-11 col-sm-offset-1">
                                ...
                                <button type="submit" class="btn btn-primary pull-right"><?php echo 'Tender Publish'; ?></button>
