<div class="col-md-6">
    <div class="form-group">
        ...
        <?php echo Form::text('mobile_number', old('mobile_number'), array('id'=> 'mobile_number', 'class' => 'form-control', 'required', 'autocomplete'=> 'off', 'placeholder'=>'Search Mobile Number ...')); ?>
...
<div class="col-md-6">
    <div class="form-group"><label class="control-label" for="stall_id">Company Name :<span class="text-danger">*</span></label>
        <?php echo Form::text('company_name', old('company_name'), array('id'=> 'company_name', 'class' => 'form-control', 'readonly')); ?>
...
<div class="col-md-6">
    <div class="form-group"><label class="control-label" for="stall_id">Email :<span class="text-danger">*</span></label>
        <?php echo Form::text('email', old('email'), array('id'=> 'email', 'class' => 'form-control', 'readonly')); ?>
...
<div class="col-md-6">
    <div class="form-group"><label class="control-label" for="stall_id">Amount :</label>
        <?php echo Form::text('amount', old('amount'), array('id'=> 'amount', 'class' => 'form-control')); ?>
