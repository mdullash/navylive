...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo url('public/css/issl_main.css'); ?>">
    ...
    <body>
        ...
        ?>
        <!-- <div class="splash"> <div class="color-line"></div><div class="splash-title"><img src="<?php echo asset($quizBook->logo); ?>" class="" width="64" height="64" /><h1 class="mm-group-text"><b><?php echo $quizBook->site_title; ?></b></h1><p></p> </div> </div> -->
        ...
        <!----------------- Main Menu Call -------------------->
        <?php echo $__env->make('includes.mainMenu', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <div id="wrapper">
            <!----------------- Container Call -------------------->
            ...
            <footer class="footer">
                ...
                Copyright &copy; <?php echo $quizBook->copy_right; ?>
        ...
        <script rel="javascript" src="<?php echo url('public/js/bootstrapValidator.min.js'); ?>"></script>
        ...
        <script rel="javascript" src="   <?php echo e(url('public/js/jquery.scrollUp.min.js')); ?>"></script>
        <?php echo Html::script("public/js/bootbox.min.js"); ?>
