...
<body>
    ...
    <div id="spinningSquaresG1">
        <div class="loader-title">
            <img src="<?php echo asset($navystg->logo); ?>">
        </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <div class="navy_news_update">
                                    <ul>
                                        <?php $__currentLoopData = $importantNotices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <a href="<?php if(!empty($itc->upload_file)): ?> <?php echo e(url('front-notice-brd-pdf/'.base64_encode($itc->id))); ?> <?php else: ?> <?php echo e('javascript:void(0)'); ?> <?php endif; ?>" target="_blank" class="text-white"><?php echo $itc->title; ?> &nbsp;&nbsp;* *</a>
                                        </li>
                            ...
                            <ul class="navbar-nav">
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle welcome-text" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <?php echo $navallocation->name; ?> <br> <span><i class="fas fa-angle-down"></i></span>
                                    </a>
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <?php if(!empty($organizationsHead)): ?>
                                            <?php $__currentLoopData = $organizationsHead; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $oh): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <!-- <a class="dropdown-item" href="<?php echo e(URL::to('/').'/'.$oh->zoneAlise.'/'.$oh->alise); ?>"><?php echo $oh->name; ?></a> -->
                                                <a class="dropdown-item" href="<?php echo $oh->external_link; ?>" target="_blank"><?php echo $oh->name; ?></a>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?> 
                                    </div>
                                </li>
            ...
            <div class="row">
                <div class="col-xl-2 col-lg-2 col-md-3 col-sm-3 col-3 tiny12">
                    ...
                    <div class="header-logo">
                         <a href="<?php echo URL::to('/').'/'.$a.$b; ?>"><img src="<?php echo asset($navystg->logo); ?>" alt="Wedding Vendor & Supplier Directory HTML Template "></a>
                    </div>
                    <!-- /.header-logo -->
                </div>
                <div class="col-xl-10 col-lg-10 col-md-9 col-sm-9 col-9 tiny12">
                    ...
                    <div id="navigation">
                        <ul>
                            <li><a href="<?php echo e(URL::to('/').'/'.$a.$b); ?>">Home</a></li>
                            <li><a href="<?php echo e(URL::to($a.$b.'front-tender/')); ?>">Tender List</a></li>
                            <li><a href="<?php echo e(URL::to($a.$b.'front-general-notice/')); ?>">General Notice</a></li>
                            <li><a href="<?php echo e(URL::to($a.$b.'front-supplier/')); ?>">Enlisted Supplier</a></li>
                            <li><a href="<?php echo e(URL::to($a.$b.'front-po-winner/')); ?>">PO Awarded</a></li>
                            <li><a href="<?php echo URL::to($a.$b.'enlistment-track'); ?>" >Enlistment Tracking</a></li>
                            <li>
                                <div class="header-btn d-flex">

                                    <a href="<?php echo e(URL::to($a.$b.'terms-condiition/')); ?>" class="btn btn-primary btn-sm">Apply for Online Enrollment</a>
                                    <?php if(Auth::guard('supplier')->check()): ?>
                                        <a href="<?php echo URL::to($a.$b.'dashboard'); ?>" class="btn btn-primary btn-sm">My Profile</a>
                                    <?php else: ?>
                                        <a href="<?php echo url($a.$b.'login'); ?>" class="btn btn-primary btn-sm">Login</a>
                                    <?php endif; ?>
