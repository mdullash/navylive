        ...
        <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2" style="">
            <div class="hpanel">
                <div class="panel-heading sub-title">
                    <?php echo trans('english.CREATE_NEW_USER'); ?>

                </div>
                <div class="panel-body">
                    <?php echo Form::open(array('role' => 'form', 'url' => 'users', 'files'=> true, 'class' => 'form-horizontal', 'id'=>'userCreate')); ?>                     
                    <div class="form-group"><label class="control-label col-xs-12 col-sm-3 no-padding-right" for="role_id"><?php echo trans('english.SELECT_ROLE'); ?> :<span class="text-danger">*</span></label>
                        <div class="col-md-6">
                            
                            <select class="form-control selectpicker" name="role_id" id="ruleIdChange"  data-live-search="true">
                                <option value=""><?php echo '- Select -'; ?></option>
                                <?php $__currentLoopData = $roleList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo $rl->id; ?>" priority="<?php echo $rl->priority; ?>"><?php echo $rl->name; ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>

                    <div class="form-group" id="zonesdiv"><label class="control-label col-md-3 no-padding-right" for="stall_id">Zone :</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group hidden" id="hideCategoriesDiv"><label class="control-label col-md-3 no-padding-right" for="stall_id">Categories :</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group"><label class="control-label col-xs-12 col-sm-3 no-padding-right" for="UserFirstName"><?php echo trans('english.FIRST_NAME'); ?> :<span class="text-danger">*</span></label>
                        <div class="col-md-6">
                            <?php echo Form::text('first_name', old('first_name'), array('id'=> 'UserFirstName', 'class' => 'form-control', 'required' => 'true')); ?>

                        </div>
                    </div>
                    <div class="form-group"><label class="control-label col-xs-12 col-sm-3 no-padding-right" for="UserLastName"><?php echo trans('english.LAST_NAME'); ?> :<span class="text-danger">*</span></label>
                        <div class="col-md-6">
                            <?php echo Form::text('last_name', old('last_name'), array('id'=> 'UserLastName', 'class' => 'form-control', 'required' => 'true')); ?>

                        </div>
                    </div>
                    <div class="form-group"><label class="control-label col-xs-12 col-sm-3 no-padding-right" for="UserUsername"><?php echo trans('english.USERNAME'); ?> :<span class="text-danger">*</span></label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group"><label class="control-label col-xs-12 col-sm-3 no-padding-right" for="UserPassword"><?php echo trans('english.PASSWORD'); ?> :<span class="text-danger">*</span></label>
                        <div class="col-md-6">
                            <?php echo Form::password('password', array('id'=> 'UserPassword', 'class' => 'form-control', 'required' => 'true')); ?>

                        </div>
                    </div>
                    <div class="form-group"><label class="control-label col-xs-12 col-sm-3 no-padding-right" for="UserConfirmPassword"><?php echo trans('english.CONFIRM_PASSWORD'); ?> :<span class="text-danger">*</span></label>
                        <div class="col-md-6">
                            <?php echo Form::password('password_confirmation', array('id'=> 'UserConfirmPassword', 'class' => 'form-control', 'required' => 'true')); ?>

                        </div>
                    </div>
                    <div class="form-group"><label class="control-label col-xs-12 col-sm-3 no-padding-right" for="UserEmail"><?php echo trans('english.EMAIL'); ?> :</label>
                        <div class="col-md-6">
                            <?php echo Form::email('email',old('email'), array('id'=> 'UserEmail', 'class' => 'form-control')); ?>

                        </div>
                    </div>
                    <div class="form-group"><label class="control-label col-xs-12 col-sm-3 no-padding-right" for="UserContactNo"><?php echo trans('english.CONTACT_NO'); ?> :</label>
                        <div class="col-md-6">
                            <?php echo Form::text('contact_no',old('contact_no'), array('id'=> 'UserContactNo', 'class' => 'form-control')); ?>

                        </div>
                    </div>
                    <div class="form-group"><label class="control-label col-xs-12 col-sm-3 no-padding-right" for="UserContactNo"><?php echo 'Rank'; ?> :</label>
                        <div class="col-md-6">
                            <?php echo Form::text('rank',old('rank'), array('id'=> 'rank', 'class' => 'form-control')); ?>

                        </div>
                    </div>
                    <div class="form-group"><label class="control-label col-xs-12 col-sm-3 no-padding-right" for="UserContactNo"><?php echo 'Designation'; ?> :</label>
                        <div class="col-md-6">
                            <?php echo Form::text('designation',old('designation'), array('id'=> 'designation', 'class' => 'form-control')); ?>

                        </div>
                    </div>

                    <div class="form-group"><label class="control-label col-xs-12 col-sm-3 no-padding-right" for="UserPhoto"><?php echo trans('english.PHOTO'); ?> :</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group"><label class="control-label col-xs-12 col-sm-3 no-padding-right" for="UserPhoto"><?php echo 'Digital Sign'; ?> :</label>
                        <div class="col-md-6">
                            <?php echo Form::file('digital_sign',old('digital_sign'), array('id'=> 'digital_sign', 'class' => 'form-control')); ?>

                            <div style="color:#B4B7B8"><?php echo 'Digital Sign'; ?></div>
                        </div>
                    </div>

                    <div class="form-group"><label class="control-label col-xs-12 col-sm-3 no-padding-right" for="userStatusId"><?php echo trans('english.STATUS'); ?> :<span class="text-danger">*</span></label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <div class="col-sm-8 col-sm-offset-2">
                            <button type="submit" class="btn btn-primary" id="formSubmitBtn"><?php echo trans('english.SAVE'); ?></button>
     ...
     $(document).ready(function () {
        ...
        $('#site_office_id').on('change', function () {
            ...
            if (siteOfficeId == '' || siteOfficeId == '0'){
               ...
               $.ajax({
                    url: "<?php echo URL::to('users/loadProject'); ?>",
                    type: "POST",
