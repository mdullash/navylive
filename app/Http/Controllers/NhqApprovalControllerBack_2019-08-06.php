...
class NhqApprovalController extends Controller
{
    ...
    public function cstViewExcel($id){ 
        ...
        Excel::create('draft-cst-view - ' . date("d-m-Y H:i"), function ($excel) use ($supplierResult, $targetArray, $supArray, $supTotalAmountArray, $demandToLprId, $supWiComArray, $supplierAllreadySelected, $demandtolpr, $tenderId, $tender,$orgInfo) {
            $excel->sheet('First Sheet', function ($sheet) use ($supplierResult, $targetArray, $supArray, $supTotalAmountArray, $demandToLprId, $supWiComArray, $supplierAllreadySelected, $demandtolpr, $tenderId, $tender,$orgInfo) {
                $row = 0;
    ...
    public function draftCstViewExcel($id){
        ...
        $tenderData = [
                ...
                Excel::create('final-cst-view - ' . date("d-m-Y H:i"), function ($excel) use ($supplierResult, $targetArray, $supArray, $supTotalAmountArray, $demandToLprId, $supWiComArray, $supplierAllreadySelected, $demandtolpr, $tenderId, $tender,$orgInfo) {
                $excel->sheet('First Sheet', function ($sheet) use ($supplierResult, $targetArray, $supArray, $supTotalAmountArray, $demandToLprId, $supWiComArray, $supplierAllreadySelected, $demandtolpr, $tenderId, $tender,$orgInfo) {
                    $row = 0;
    ...
    public function nhqCstViewExcel($id){
        ...
        $tenderData = [
                ...
                Excel::create('nhq-cst-view - ' . date("d-m-Y H:i"), function ($excel) use ($supplierResult, $targetArray, $supArray, $supTotalAmountArray, $demandToLprId, $supWiComArray, $supplierAllreadySelected, $demandtolpr, $tenderId, $tender,$orgInfo) {
                $excel->sheet('First Sheet', function ($sheet) use ($supplierResult, $targetArray, $supArray, $supTotalAmountArray, $demandToLprId, $supWiComArray, $supplierAllreadySelected, $demandtolpr, $tenderId, $tender,$orgInfo) {
                    $row = 0;
