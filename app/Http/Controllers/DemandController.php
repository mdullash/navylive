    ...
    { 
        ...
        if($demandDetailPageFromRoute == 'demand'){
            $demands = Demand::whereNotNull('id')->orderBy('id', 'desc');
                            ...
                            if(!empty($demand_no)){
                                $demands->where('demand_no','Like',"%$demand_no%");
                            }
                            if(!empty($from)){
        ...
        if($demandDetailPageFromRoute == 'group-check-acc'){
            if($prm == 1){
                ...
                $demands = \App\DemandToLpr::whereIn('id',$countRestItems)
                                ->orderBy('id', 'desc');
                                if(!empty($catGrou)){
                                    $demands->whereIn('id',$demandToLprIdAcToCat);
                                }
                                if(!empty($demande)){
                                    $demands->where('requester','=',$demande);
                                }
            ...
            if($prm == 2){
                ...
                $demands = \App\DemandToLpr::where('demand_appv_status', '=', 1)->whereNotNull('demand_no')->whereIn('id', $countRestItems)
                    ->orderBy('id', 'desc');
                    if(!empty($catGrou)){
                        $demands->whereIn('id',$demandToLprIdAcToCat);
                    }
        ...
        if($demandDetailPageFromRoute == 'floating-tender-acc'){
            if($prm == 1){
                ...
                $demands = \App\DemandToLpr::leftJoin('demand_to_tender', 'demand_to_lpr.id', '=', 'demand_to_tender.lpr_id')
                    ...
                    return View::make('floating-tender.index')->with(compact('demands','demandDetailPageFromRoute','demandeNames','demande','demand_no','from','todate'));
            ...
            if($prm == 3){
                $demands = \App\PoDatas::join('demand_to_lpr', 'demand_to_lpr.id', '=', 'po_datas.lpr_id')
                    ...
                    if(!empty($po_no)){
                     ...
                     if(!empty($from)){
                        $demands->whereDate('po_datas.top_date','>=',$from);
                    }
                    if(!empty($todate)){
                        $demands->whereDate('po_datas.top_date','<=',$todate);
                    }
                    
                $demands = $demands->paginate(10);
                return View::make('po-generation.po-check')->with(compact('demands','demand_no','demandDetailPageFromRoute'));
//
            }
            if($prm == 4){
                $demands = \App\PoDatas::join('demand_to_lpr', 'demand_to_lpr.id', '=', 'po_datas.lpr_id')
                ...
                $demands = $demands->paginate(10);
                return View::make('po-generation.po-approve')->with(compact('demands','demand_no','demandDetailPageFromRoute'));
//
            }
            if($prm == 2){
                $demands = \App\PoDatas::join('demand_to_lpr', 'demand_to_lpr.id', '=', 'po_datas.lpr_id')
                ...
                $demands = $demands->paginate(10);
                return View::make('po-generation.po-generated')->with(compact('demands','demand_no','demandDetailPageFromRoute'));
            }
        }
        if($demandDetailPageFromRoute == 'cr-view-acc'){
            ...
            if($prm == 1){
                ...
                $demands = \App\PoDatas::join('demand_to_lpr', 'demand_to_lpr.id', '=', 'po_datas.lpr_id')
                    ...
                    ->select('po_datas.*',$this->tableAlies.'_suppliers.company_name',$this->tableAlies.'_tenders.tender_title')
                    ->where('po_datas.po_approve_status','=',1)
                ...
                $demands = $demands->paginate(10);
                return View::make('cr-view.index')->with(compact('demands','demand_no','demandDetailPageFromRoute','po_no','from','todate'));
            }
            if($prm == 2){
                ...
                $demands = \App\DemandPoToCr::join('po_datas', 'po_datas.id', '=', 'demand_po_to_cr.po_id')
                    ...
                    ->leftjoin('demand_to_collection_quotation','demand_to_collection_quotation.id', '=', 'po_datas.selected_supplier')
                    ->leftjoin($this->tableAlies.'_suppliers',$this->tableAlies.'_suppliers.id', '=', 'demand_to_collection_quotation.supplier_name')
                    ->select('po_datas.*',$this->tableAlies.'_suppliers.company_name',$this->tableAlies.'_tenders.tender_title', 'demand_po_to_cr.id', 'demand_po_to_cr.cr_receive_qty', 'demand_po_to_cr.cr_number')
                ...
                $demands = $demands->paginate(10);
                return View::make('cr-view.index-for-sigment-two')->with(compact('demands','demand_no','demandDetailPageFromRoute','cr_no','from','todate'));
            }
            if($prm == 3){
                $cr_no = Input::get('cr_no');
                $demands = \App\DemandPoToCr::join('po_datas', 'po_datas.id', '=', 'demand_po_to_cr.po_id')
        ...
        if($demandDetailPageFromRoute == 'inspection-view-acc'){
            ...
            if($prm == 1){
                ...
                $demands = $demands->paginate(10);
                return View::make('inspection-view.index')->with(compact('demands','demand_no','demandDetailPageFromRoute','cr_no','from','todate'));
        ...
        if($demandDetailPageFromRoute == 'v44-voucher-view-acc'){
            ...
            if($prm == 1){
                ...
                $demands = \App\DemandCrToInspection::join('demand_po_to_cr', 'demand_po_to_cr.id', '=', 'demand_cr_to_inspection.dmnd_po_to_cr_id')
                    ...
                    ->leftjoin('demand_to_collection_quotation','demand_to_collection_quotation.id', '=', 'po_datas.selected_supplier')
                    ->leftjoin($this->tableAlies.'_suppliers',$this->tableAlies.'_suppliers.id', '=', 'demand_to_collection_quotation.supplier_name')
                    ->select('po_datas.*',$this->tableAlies.'_suppliers.company_name',$this->tableAlies.'_tenders.tender_title', 'demand_cr_to_inspection.id', 'demand_po_to_cr.cr_receive_qty', 'demand_po_to_cr.cr_number')
                    ->where('demand_po_to_cr.status','=',1)
                ...
                $demands = $demands->paginate(10);
                return View::make('d44b.index')->with(compact('demands','demand_no','demandDetailPageFromRoute','cr_no','from','todate'));
            }
            if($prm == 2){
                $cr_no = Input::get('cr_no');
                $demands = \App\D44BData::join('demand_cr_to_inspection', 'demand_cr_to_inspection.id', '=', 'd44b_datas.inspecttion_id')
                    ...
                    ->leftjoin('demand_to_collection_quotation','demand_to_collection_quotation.id', '=', 'po_datas.selected_supplier')
                    ->leftjoin($this->tableAlies.'_suppliers',$this->tableAlies.'_suppliers.id', '=', 'demand_to_collection_quotation.supplier_name')
                    ->select('po_datas.*',$this->tableAlies.'_suppliers.company_name',$this->tableAlies.'_tenders.tender_title', 'd44b_datas.id', 'demand_po_to_cr.cr_receive_qty', 'demand_po_to_cr.cr_number')
        ...
        if($demandDetailPageFromRoute == 'issue'){
            $this->tableAlies = \Session::get('zoneAlise');
            if($prm == 1){
                $cr_no = Input::get('cr_no');
                $demands = \App\D44BData::join('demand_cr_to_inspection', 'demand_cr_to_inspection.id', '=', 'd44b_datas.inspecttion_id')
                    ...
                    ->select('po_datas.*',$this->tableAlies.'_suppliers.company_name',$this->tableAlies.'_tenders.tender_title', 'd44b_datas.id', 'demand_po_to_cr.cr_receive_qty', 'demand_po_to_cr.cr_number')
                    ->whereNotNull('d44b_datas.status')
                    ->whereNull('d44b_datas.issue_status')
                    ->orderBy('demand_po_to_cr.id', 'desc');
                if(!empty($cr_no)){
                    $demands->where('demand_po_to_cr.cr_number','Like',"%$cr_no%");
                }
                ...
                $demands = $demands->paginate(10);
                return View::make('issue.index')->with(compact('demands','demand_no','demandDetailPageFromRoute','cr_no','from','todate'));
            }
            if($prm == 2){
                $cr_no = Input::get('cr_no');
                $demands = \App\IssueDatas::join('d44b_datas', 'd44b_datas.id', '=', 'issue_datas.d44b_datas_id')
                    ->leftJoin('demand_cr_to_inspection', 'demand_cr_to_inspection.id', '=', 'd44b_datas.inspecttion_id')
                    ->leftJoin('demand_po_to_cr', 'demand_po_to_cr.id', '=', 'demand_cr_to_inspection.dmnd_po_to_cr_id')
                    ->leftJoin('po_datas', 'po_datas.id', '=', 'demand_po_to_cr.po_id')
                    ->leftJoin('demand_to_lpr', 'po_datas.lpr_id', '=', 'demand_to_lpr.id')
                    ->leftJoin('demande_name', 'demande_name.id', '=', 'demand_to_lpr.requester')
                    ...
                    ->leftjoin('demand_to_collection_quotation','demand_to_collection_quotation.id', '=', 'po_datas.selected_supplier')
                    ->leftjoin($this->tableAlies.'_suppliers',$this->tableAlies.'_suppliers.id', '=', 'demand_to_collection_quotation.supplier_name')
                    ->select('po_datas.*',$this->tableAlies.'_suppliers.company_name',$this->tableAlies.'_tenders.tender_title', 'd44b_datas.id', 'demand_po_to_cr.cr_receive_qty', 'demand_po_to_cr.cr_number','issue_datas.id as issue_id')
                    ->where('issue_datas.status',1)
                    ->whereNotNull('d44b_datas.status')
                    ->orderBy('demand_po_to_cr.id', 'desc');
        ...
        if($demandDetailPageFromRoute == 'bill'){
            $this->tableAlies = \Session::get('zoneAlise');
            if($prm == 1){
                $cr_no = Input::get('cr_no');
                $demands = \App\D44BData::join('demand_cr_to_inspection', 'demand_cr_to_inspection.id', '=', 'd44b_datas.inspecttion_id')
                ...
                $demands = $demands->paginate(10);
                return View::make('bill.index')->with(compact('demands','demand_no','demandDetailPageFromRoute','cr_no','from','todate'));
            }
...
// echo "<pre>"; print_r($request->all()); exit;
    ...
    public function demandDetail($id)
    {
        ...
        $id                 = $sigMent[0];
        if(empty($demOrdemtoLpr)){
            $demand             = Demand::find($id);
        }else{
            $demand             = \App\DemandToLpr::find($id);
        }
        $itemtodemand       = '';
        $itemtodemandappv   = '';
        $catGrou            = Auth::user()->categories_id;
        ...
        if(!empty($demand)){
            ...
            $itemtodemand = \App\ItemToDemand::join($this->tableAlies.'_items', $this->tableAlies.'_items.id', '=', 'item_to_demand.item_id')
                ...
                if(empty($demOrdemtoLpr)){
                    $itemtodemand->where('demand_id','=',$demand->id);
                }else{
                    $itemtodemand->where('lpr_id','=',$demand->id);
                }
                if(!empty($catGrou)){
                    $catGrou = explode(',',$catGrou);
        ...
        return View::make('demands.demand-details')->with(compact('demand','itemtodemand','destinationPlaces','inspectedItems','routenNameComeOfThePge','itemtodemandappv','demOrdemtoLpr'));
    }
    ...
    public function postOnlyGroupStatusChange(Request $request){
        ...
        if($request->sigment==3){
            ...
            if(!empty($demandtolpr)){
                ...
                $demandtolprUpd->demand_appv_status          = $demandsUp->demand_appv_status;
                $demandtolprUpd->approved_by                 = $demandsUp->approved_by;
                $demandtolprUpd->approved_date               = $demandsUp->approved_date;
                $demandtolprUpd->save();
            }
        }
    ...
    public function demandPendingPost(Request $request){
        ...
        if($request->updateFilelds  == 2){
            ...
            \DB::table('demand_to_tender')
                ...
                ->update(['float_tender_app_status' => $request->demand_approval, 'float_tender_app_by' =>  Auth::user()->id,'float_tender_app_rank' =>  Auth::user()->rank ,'float_tender_app_at' => date('Y-m-d H:i:s'), 'current_status' => 5]);
        ...
        if($request->updateFilelds  == 3){
            ...
            if(!empty($demandToLprUp->demand_ids) && count($demandIds)>0){
                foreach ($demandIds as $diss) {
                    $demandUpda = Demand::find($diss);
                    $demandUpda->coll_quat_app_status        = $request->demand_approval;
                    $demandUpda->coll_quat_app_by            = Auth::user()->id;
                    $demandUpda->coll_quat_app_at            = date('Y-m-d H:i:s');
                    $demandUpda->current_status              = 7;
                    $demandUpda->save();
                }
            }
            
            
            $demandToLprUp->coll_quat_app_status     = $request->demand_approval;
            $demandToLprUp->coll_quat_app_by         = Auth::user()->id;
            $demandToLprUp->coll_quat_app_at         = date('Y-m-d H:i:s');
            $demandToLprUp->current_status           = 7;
            ...
            \DB::table('demand_to_tender')
                ->where('lpr_id', $request->demandId)
                ->where('tender_id', $tenderId)
                ->update(['coll_quat_app_status' => $request->demand_approval, 'coll_quat_app_by' =>  Auth::user()->id,'coll_quat_app_rank' =>  Auth::user()->rank ,'coll_quat_app_at' => date('Y-m-d H:i:s'), 'current_status' => 7]);
    ...
    public function directItemDmndCreate(){
        ...
        $tenderTearmsAndConditions = \App\TermsCondition::where('status','=',1)->where('category_id','=',1)->get();
    ...
    public function demandGetPrint($id){
        ...
        $demandss = DB::table('item_to_demand')
                    ...
                    ->where('item_to_demand.lpr_id','=',$id)->orderBy('group_name')->orderBy('item_to_demand.item_id')
                    ->select('item_to_demand.id as item_to_demand_id',
                        ...
                        'demands.pattern_or_stock_no  as demands_pattern_or_stock_no',
                        'demands.reference_date  as demands_reference_date',
                        ...
                        'demand_to_lpr.lpr_date  as demands_lpr_date',
                        'demand_to_lpr.sample_number  as demands_lpr_sample_number',
                    ...
                    foreach ($demandss as $key => $value) {
                    	$itemId = $value->items_id;
                    	if(isset($demandss[$i]) && $demandss[$i]->items_id == $itemId && $demandss[$i]->item_to_demand_group_name == $value->item_to_demand_group_name){
                    		$totalQty += $value->item_to_demand_total_unit;
                    			
                    	}else{

                    		$preViousItemInfo = \App\DemandSuppllierToCollQuotToItem::where('real_item_id','=',$itemId)->where('select_as_winner','=',1)->orderBy('id','desc')->first();

                    		if(!empty($preViousItemInfo)){
                    			$value->itemtotender_unit_price = $preViousItemInfo->unit_price;
                    			$value->itemtotender_quantity = $preViousItemInfo->quoted_quantity;

                    			$tenInfo = \App\Tender::find($preViousItemInfo->tender_id);
                    			if(!empty($tenInfo)){
                    				$value->tenders_po_number = $tenInfo->po_number;
                    				$value->tenders_purchase_order_date = $tenInfo->valid_date_from;
                    			}else{
                    				$value->tenders_po_number = null;
                    				$value->tenders_purchase_order_date = null;
                    			}

                    			$supplierInfo = \App\Supplier::find($preViousItemInfo->supplier_id);
                    			if(!empty($tenInfo)){
                    				$value->suppliers_company_name = $supplierInfo->company_name;
                    			}else{
                    				$value->suppliers_company_name = null;
                    			}
                    		}else{
                    			$value->itemtotender_unit_price = null;
                    			$value->itemtotender_quantity = null;
                    			$value->tenders_po_number = null;
                    			$value->tenders_purchase_order_date = null;
                    			$value->suppliers_company_name = null;
                    		}

                    		$value->item_to_demand_total_unit = $value->item_to_demand_total_unit+$totalQty;
                    		$demands[] = $value;
                    		$totalQty = 0;
                    	}
...
//		    return view('demands.store-demand-long-print',$values);
            ...
            //dd($demands);
	        $pdf = PDF::loadView('demands.store-demand-print',$demands,[],['format' => [175, 225],'orientation' => 'L']);
	        return $pdf->stream('store-demand-print.pdf');
	    }
