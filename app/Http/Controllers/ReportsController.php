...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if($paginatorRange>0){
            ...
            $supplierForGndT = \App\Tender::join($this->tableAlies.'_itemtotender', $this->tableAlies.'_itemtotender.tender_id', '=', $this->tableAlies.'_tenders.all_org_tender_id')
            ...
            if(!empty($sup_id)){
                ...
                $supplierForGndT->where($this->tableAlies.'_suppliers.id','=',$sup_id);
            }
            if(!empty($item_id)){
...
// start range search ====================================
            ...
            $groupBySupplierIds = \App\Tender::join($this->tableAlies.'_itemtotender', $this->tableAlies.'_itemtotender.tender_id', '=', $this->tableAlies.'_tenders.all_org_tender_id')
                ->join($this->tableAlies.'_suppliers',$this->tableAlies.'_suppliers.all_org_id','=',$this->tableAlies.'_tenders.supplier_id')
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if($paginatorRange>0){
            ...
            if(!empty($ten_title)){
                $supplierForGndT->whereIn($this->tableAlies.'_tenders.id',$tenderTitlIds);
            }
            if(!empty($ten_number)){
                $supplierForGndT->whereIn($this->tableAlies.'_tenders.id',$tenderNumIds);
            }
            if(!empty($po_number)){
...
// End search ===============================================================
    ...
    public function catProSupplierList(Request $request){
        ...
        if(!empty($cat_id) || !empty($item_id) || !empty($nsd_id)){
            ...
            if(!empty($item_id)){
                ...
                if(!empty($items)){
                    $itemss = Tender::whereIn('all_org_tender_id',$items)->get();
                    $valuesss = [];
    ...
    public function supplierReport(){
        ...
        $suppliers = $suppliers->whereIn('id',$zonesRltdIdsss)->paginate(25);
