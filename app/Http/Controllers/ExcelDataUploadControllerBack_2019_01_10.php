...
//                    }
                    ...
                    if(!empty($item_id)){
                        ...
                        $itemtotender->quantity =  empty(trim($csvData[$i]['quantity'])) ? null : trim($csvData[$i]['quantity']);
                        $itemtotender->unit_price = empty(trim($csvData[$i]['unit_price'])) ? null : trim($csvData[$i]['unit_price']);
                        ...
                        $itemtotender->unit_price_in_bdt = trim($csvData[$i]['unit_price'])*$conversionRate;
