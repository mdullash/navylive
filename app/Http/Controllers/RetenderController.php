...
class RetenderController extends Controller
{
    ...
    public function create($id)
    {
        ...
        $retednderId        = \App\Retender::where('lpr_id','=',$explodes[0])->value('id');
        $retednderInfo      = \App\Retender::find($retednderId);
        ...
        return View::make('retender.create')->with(compact('supplyCategories','nsdNames','id','demandToLprInfo','tenderNoFor','itemtodemand','tenderTearmsAndConditions','tenderInfo','demand_to_lpr_id','tenderId','retednderId','retednderInfo'));
    }
    ...
    public function retenderPost(Request $request)
    {
        ...
        $this->middleware('csrf', array('on' => 'post'));
            ...
            if(count($request->item_to_tender_assing)>0){
                ...
                $retednderInfo      = \App\Retender::find($request->retednderId);
                ...
                $demandtolpr->total_unit                    = $retednderInfo->retenderQty;
                ...
                $demandtolpr->save();  
                    ...
                    $updateRetender = \App\Retender::where('id','=',$request->retednderId)->where('tender_id','=',$tenderId)->first();
                ...
                return Redirect::to('retender-create/'.$request->retednderId.'&'.$tenderId);
            }
