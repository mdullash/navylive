            ...
            return redirect('zone/create')->withErrors($v->errors())->withInput();
               ...
               if ($zone->save()) {
                   ...
                   Schema::create(strtolower($zone->alise).'_suppliers', function ($table) {
                       ...
                       $table->string('enlistment_status')->nullable();
                       $table->integer('status_id')->default(1);
                       $table->integer('created_by');
                       $table->integer('updated_by');
                       $table->timestamps();
...
//                    Supplier personal informationb Table ===============================================================
                   ...
                   Schema::create(strtolower($zone->alise).'_sells_form', function ($table) {
                       $table->increments('id');
                       $table->string('company_name');
                   ...
                   Schema::create(strtolower($zone->alise).'_supplier_approved', function ($table) {
                       $table->increments('id');
                       $table->date('date');
                       $table->string('letter_no');
                       $table->string('info');
                       $table->string('encloser');
                       $table->string('dni_status');
                       $table->string('npm_status');
                       $table->string('status');
                       $table->integer('created_by');
                       $table->integer('updated_by');
                       $table->timestamps();
                   ...
                   Schema::create(strtolower($zone->alise).'_supplier_approval_info', function ($table) {
                       $table->increments('id');
                       $table->integer('approve_id');
                       $table->integer('supplier_id');
                       $table->string('dni_description');
                       $table->string('npm_description');
                       $table->string('status');
                       $table->integer('created_by');
                       $table->integer('updated_by');
                       $table->timestamps();
                   ...
                   Schema::create(strtolower($zone->alise).'_supplier_npm_dni_approved', function ($table) {
                       $table->increments('id');
                       $table->date('date');
                       $table->string('letter_no');
                       $table->string('info');
                   ...
                   Schema::create(strtolower($zone->alise).'_supplier_npm_dni_approval_info', function ($table) {
                       $table->increments('id');
                       $table->integer('supplier_approval_id');
                       $table->integer('approve_id');
                       $table->integer('supplier_id');
                       $table->string('status');
                       $table->integer('created_by');
                   ...
                   Schema::create(strtolower($zone->alise).'_supplier_approval_after_dns_approval', function ($table) {
                       $table->increments('id');
                       $table->date('date');
                       $table->string('letter_no');
                       $table->string('info');
                   ...
                   Schema::create(strtolower($zone->alise).'_supplier_approval_info_after_dns_approval', function ($table) {
                       $table->increments('id');
                       $table->integer('supplier_approval_id');
                       $table->integer('approve_id');
                       $table->integer('supplier_id');
        ...
        if ($v->fails()) {
            return redirect('zone/edit/'.$id)->withErrors($v->errors())->withInput();
               ...
               if ($zone->save()) {
                   ...
                   Schema::create(strtolower($zone->alise).'_id_card_purchase', function ($table) {
                       $table->increments('id');
                       $table->string('company_name');
                       $table->string('company_reg_number');
                       $table->string('barcode_number')->nullable();
                   ...
                   Schema::create(strtolower($zone->alise).'_renew_supplier', function ($table) {
                       $table->increments('id');
                       $table->string('company_name');
                       $table->string('company_reg_number');
                       $table->string('barcode_number')->nullable();
