...
//
            ...
            if($prm == 3){
                $demands = \App\PoDatas::join('demand_to_lpr', 'demand_to_lpr.id', '=', 'po_datas.lpr_id')
                    ...
                    if(!empty($tender_no)){
                        $demands->where('po_datas.tender_number','=',$tender_no);
                    }
...
//
        ...
        if($demandDetailPageFromRoute == 'cr-view-acc'){
            if($prm == 1){
                ...
                $demands = $demands->paginate(10);
                return View::make('cr-view.index')->with(compact('demands','demand_no','demandDetailPageFromRoute'));
            }
            if($prm == 2){
...
// echo "<pre>"; print_r($request->all()); exit;
    ...
    public function demandGetPrint($id){
        ...
        $demandss = DB::table('item_to_demand')
                    ...
                    //->leftJoin( 'demands','demands.id','=', 'item_to_demand.demand_id')
