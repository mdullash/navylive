...
//        $supplyCategories = SupplyCategory::where('status_id','=',1)->get();
        ...
        return View::make('floating-tender.create')->with(compact('supplyCategories','nsdNames','id','demandToLprInfo','tenderNoFor','itemtodemand','tenderTearmsAndConditions'));
    }
...
//        $demandId = $id;
        ...
        return View::make('demands.cst-view')->with(compact('itemList','supplierResult','targetArray','supArray','supTotalAmountArray','demandId','supplierAllreadySelected','supWiComArray','demand','tenderId','tender','suppliersInf','orgInfo'));
        ...
        return View::make('lot-cst.cst-view')->with(compact('itemList','supplierResult','targetArray','supArray','supTotalAmountArray','demandId','supplierAllreadySelected','supWiComArray','demand','tenderId','tender','suppliersInf','supplierResultFir','mainArray','orgInfo'));
        } 
...
//        $demandId = $id;
    ...
    public function draftCstView($id){
        ...
        if($mainTenderInfo->tender_nature != 2){
            ...
            return View::make('demands.cst-draft-view')->with(compact('itemList','supplierResult','targetArray','supArray','supTotalAmountArray','demandId','supplierAllreadySelected','supWiComArray','demand','tenderId','tender','suppliersInf','orgInfo'));
        }else{
            ...
            return View::make('lot-cst.cst-draft-view')->with(compact('itemList','supplierResult','targetArray','supArray','supTotalAmountArray','demandId','supplierAllreadySelected','supWiComArray','demand','tenderId','tender','suppliersInf','supplierResultFir','mainArray','orgInfo'));
