...
class PoGenerationController extends Controller
{
    ...
    public function crSection($id){
        ...
        $demandPoToCrInfo = \App\DemandPoToCr::where('po_id','=',$poDtsId)->first();

        return View::make('cr-view.cr-view')->with(compact('demandId','selectedSupplier','demandInfo','qyeryResutl','tenderId','demandToTenInfo','lprId','poDtsId','demandPoToCrInfo','poDatasInfo'));
