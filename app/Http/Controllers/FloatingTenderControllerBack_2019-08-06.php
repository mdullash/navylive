...
//        $demandId = $id;
        ...
        return View::make('demands.cst-view')->with(compact('itemList','supplierResult','targetArray','supArray','supTotalAmountArray','demandToLprId','supplierAllreadySelected','supWiComArray','demandtolpr','tenderId','tender','suppliersInf','orgInfo'));
        ...
        return View::make('lot-cst.cst-view')->with(compact('itemList','supplierResult','targetArray','supArray','supTotalAmountArray','demandToLprId','supplierAllreadySelected','supWiComArray','demandtolpr','tenderId','tender','suppliersInf','supplierResultFir','mainArray','orgInfo'));
        } 
...
//        $demandId = $id;
    ...
    public function draftCstView($id){
        ...
        if($mainTenderInfo->tender_nature != 2){
            ...
            return View::make('demands.cst-draft-view')->with(compact('itemList','supplierResult','targetArray','supArray','supTotalAmountArray','demandToLprId','supplierAllreadySelected','supWiComArray','demandtolpr','tenderId','tender','suppliersInf','orgInfo'));
        }else{
