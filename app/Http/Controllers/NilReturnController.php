...
class NilReturnController extends Controller
{
    ...
    public function create($id){
	    ...
	    return view('nil-return.create',compact('nilId','nilReturn'));
    }
    ...
    public function nilReturnPrint($id){
	    ...
	    {
		    //		    find latest tander
		    $tendertLatest = \App\Tender::find($tenderId);
		    $tenderNumberLatest = $tendertLatest->tender_number;
		    $tenderLatestId = $tenderId;


		    //		    find oldest tander
		    $tenderFirst  = \App\Tender::where('tender_number','Like',"%$tendertLatest->tender_number%")->oldest()->first();
