...
class BsdDhakaSuppliers extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'bsddhaka:suppliers';
     ...
     * @var string
     */
    protected $description = 'Fetch data for supplier for bsd dhaka';
    ...
    {
        $live_url = "http://navy.isslsolutions.com/api/api-supplier/bsd/bsd_dhaka/"; // For bsd dhaka supplier data
        ...
        $live_url = "http://navy.isslsolutions.com/api/api-supplier/bsd/bsd_dhaka/".$lastUpldatedDateTime; // For bsd dhaka supplier data
