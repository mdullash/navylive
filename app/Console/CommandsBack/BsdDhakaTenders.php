...
class BsdDhakaTenders extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'bsddhaka:tenders';
     ...
     * @var string
     */
    protected $description = 'Fetch data fro nsd dhaka tender';
    ...
    public function handle()
    {
        ...
        $live_url = "http://navy.isslsolutions.com/api/api-tenders/bsd/bsd_dhaka/"; // For nsd dhaka tender data
        ...
        $live_url = "http://navy.isslsolutions.com/api/api-tenders/bsd/bsd_dhaka/".$lastUpldatedDateTime; // For bsd dhaka tenders data
