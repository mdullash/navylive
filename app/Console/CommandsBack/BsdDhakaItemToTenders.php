...
class BsdDhakaItemToTenders extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'bsddhaka:itemtotenders';
     ...
     * @var string
     */
    protected $description = 'Fetch Item to Tender Data for Bsd Dhaka';
    ...
    public function handle()
    {
        ...
        $live_url = "http://navy.isslsolutions.com/api/api-itemtotenders/bsd/bsd_dhaka/"; // For nsd dhaka itemtotenders data
        ...
        $live_url = "http://navy.isslsolutions.com/api/api-itemtotenders/bsd/bsd_dhaka/".$lastUpldatedDateTime; // For bsd dhaka itemtotenders data
