...
class NsdDhakaSuppliers extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'nsddhaka:suppliers';
     ...
     * @var string
     */
    protected $description = 'Fetch data for supplier for nsd dhaka';
    ...
    public function handle()
    {
        ...
        $live_url = "http://navy.isslsolutions.com/api/api-supplier/nsd/nssd_dhaka/"; // For nssd dhaka supplier data
        ...
        $live_url = "http://navy.isslsolutions.com/api/api-supplier/nsd/nssd_dhaka/".$lastUpldatedDateTime; // For nas dhaka supplier data
