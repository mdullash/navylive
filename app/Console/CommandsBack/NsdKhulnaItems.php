...
class NsdKhulnaItems extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'nsdkhulna:items';
     ...
     * @var string
     */
    protected $description = 'Fetch items data for nsd khulna';
    ...
    {
        $live_url = "http://navy.isslsolutions.com/api/api-items/nsd/nsd_khulna/"; // For nsd khulna items data
        ...
        $live_url = "http://navy.isslsolutions.com/api/api-items/nsd/nsd_khulna/".$lastUpldatedDateTime; // For nsd khulna items data
