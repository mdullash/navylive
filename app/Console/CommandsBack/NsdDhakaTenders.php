...
class NsdDhakaTenders extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'nsddhaka:tenders';
    ...
    public function handle()
    {
        ...
        $live_url = "http://navy.isslsolutions.com/api/api-tenders/nsd/nssd_dhaka/"; // For nsd dhaka tender data
        ...
        $live_url = "http://navy.isslsolutions.com/api/api-tenders/nsd/nssd_dhaka/".$lastUpldatedDateTime; // For nsd dhaka tenders data
