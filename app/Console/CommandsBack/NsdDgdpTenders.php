...
class NsdDgdpTenders extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'nsddgdp:tenders';
    ...
    public function handle()
    {
        ...
        $live_url = "http://navy.isslsolutions.com/api/api-tenders/nsd/dgdp/"; // For nsd dgdp tender data
        ...
        $live_url = "http://navy.isslsolutions.com/api/api-tenders/nsd/dgdp/".$lastUpldatedDateTime; // For nsd tenders data
