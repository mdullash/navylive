...
class NsdDhakaItemToTenders extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'nsddhaka:itemtotenders';
     ...
     * @var string
     */
    protected $description = 'Fetch Item to Tender Data for nsd Dhaka';
    ...
    public function handle()
    {
        ...
        $live_url = "http://navy.isslsolutions.com/api/api-itemtotenders/nsd/nssd_dhaka/"; // For nsd dhaka itemtotenders data
        ...
        $live_url = "http://navy.isslsolutions.com/api/api-itemtotenders/nsd/nssd_dhaka/".$lastUpldatedDateTime; // For nsd dhaka itemtotenders data
