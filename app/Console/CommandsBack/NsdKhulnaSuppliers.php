...
class NsdKhulnaSuppliers extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'nsdkhulna:suppliers';
     ...
     * @var string
     */
    protected $description = 'Fetch data for supplier for nsd khulna';
    ...
    public function handle()
    {
        ...
        $live_url = "http://navy.isslsolutions.com/api/api-supplier/nsd/nsd_khulna/"; // For nsd Khulna supplier data
        ...
        $live_url = "http://navy.isslsolutions.com/api/api-supplier/nsd/nsd_khulna/".$lastUpldatedDateTime; // For nsd Khulna supplier data
