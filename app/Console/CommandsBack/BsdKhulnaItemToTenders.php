...
class BsdKhulnaItemToTenders extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'bsdkhulna:itemtotenders';
     ...
     * @var string
     */
    protected $description = 'Fetch Item to Tender Data for Bsd Khulna';
    ...
    public function handle()
    {
        ...
        $live_url = "http://navy.isslsolutions.com/api/api-itemtotenders/bsd/bsd_khulna/"; // For nsd khulna itemtotenders data
        ...
        $live_url = "http://navy.isslsolutions.com/api/api-itemtotenders/bsd/bsd_khulna/".$lastUpldatedDateTime; // For bsd khulna itemtotenders data
