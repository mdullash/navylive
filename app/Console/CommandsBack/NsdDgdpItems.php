...
class NsdDgdpItems extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'nsddgdp:items';
     ...
     * @var string
     */
    protected $description = 'Fetch items data for nsd dgdp';
    ...
    {
        $live_url = "http://navy.isslsolutions.com/api/api-items/nsd/dgdp/"; // For nsd dgdp items data
        ...
        $live_url = "http://navy.isslsolutions.com/api/api-items/nsd/dgdp/".$lastUpldatedDateTime; // For nsd dgdp items data
