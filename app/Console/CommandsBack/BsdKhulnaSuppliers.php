...
class BsdKhulnaSuppliers extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'bsdkhulna:suppliers';
     ...
     * @var string
     */
    protected $description = 'Fetch data for supplier for bsd khulna';
    ...
    public function handle()
    {
        ...
        $live_url = "http://navy.isslsolutions.com/api/api-supplier/bsd/bsd_khulna/"; // For bsd Khulna supplier data
        ...
        $live_url = "http://navy.isslsolutions.com/api/api-supplier/bsd/bsd_khulna/".$lastUpldatedDateTime; // For bsd Khulna supplier data
