...
class BsdKhulnaTenders extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'bsdkhulna:tenders';
    ...
    public function handle()
    {
        ...
        $live_url = "http://navy.isslsolutions.com/api/api-tenders/bsd/bsd_khulna/"; // For bsd khulna tender data
        ...
        $live_url = "http://navy.isslsolutions.com/api/api-tenders/bsd/bsd_khulna/".$lastUpldatedDateTime; // For bsd khulna tender data
