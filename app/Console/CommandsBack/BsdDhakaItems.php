...
class BsdDhakaItems extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'bsddhaka:items';
     ...
     * @var string
     */
    protected $description = 'Fetch items data for bsd dhaka';
    ...
    public function handle()
    {
        ...
        $live_url = "http://navy.isslsolutions.com/api/api-items/bsd/bsd_dhaka/"; // For bsd dhaka items data
        ...
        $live_url = "http://navy.isslsolutions.com/api/api-items/bsd/bsd_dhaka/".$lastUpldatedDateTime; // For bsd dhaka items data
