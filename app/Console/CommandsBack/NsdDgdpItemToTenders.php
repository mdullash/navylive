...
class NsdDgdpItemToTenders extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'nsddgdp:itemtotenders';
     ...
     * @var string
     */
    protected $description = 'Fetch Item to Tender Data for Bsd Dgdp';
    ...
    public function handle()
    {
        ...
        $live_url = "http://navy.isslsolutions.com/api/api-itemtotenders/nsd/dgdp/"; // For nsd dgdp itemtotenders data
        ...
        $live_url = "http://navy.isslsolutions.com/api/api-itemtotenders/nsd/dgdp/".$lastUpldatedDateTime; // For nsd dgdp itemtotenders data
