...
class BsdKhulnaItems extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'bsdkhulna:items';
     ...
     * @var string
     */
    protected $description = 'Fetch items data for bsd khulna';
    ...
    public function handle()
    {
        ...
        $live_url = "http://navy.isslsolutions.com/api/api-items/bsd/bsd_khulna/"; // For bsd khulna items data
        ...
        $live_url = "http://navy.isslsolutions.com/api/api-items/bsd/bsd_khulna/".$lastUpldatedDateTime; // For bsd khulna items data
