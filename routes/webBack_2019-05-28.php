...
Route::group(['middleware'=>'authCheck'],function (){
    ...
    Route::group(array('middleware' => 'authCheck'), function() {
        ...
        Route::get('v44-voucher-view-acc','DemandController@index');
        //===========================================
        //===========================================
        ...
        Route::get('headquarte-approval/{data}', 'FloatingTenderController@headquarteApproval');
        Route::post('post-headquarte-approval', 'FloatingTenderController@postHeadquarteApproval');
        // PO Generation ===================================
        ...
        Route::any('terms-conditions', 'TermsConditionController@create');
