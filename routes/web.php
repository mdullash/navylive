...
Route::get('/psimstv', 'TenderTvController@index');
...
// Category & Item Wise Supplier
        ...
        Route::get('/supplier-chat-list','FrontEndController@nssdSupplierChatList');
        Route::get('/supplier-chat/{id}','FrontEndController@nssdSupplierChat');
        Route::post('/supplier-chat-submit','FrontEndController@nssdSupplierChatPost');

        Route::get('/message-to-supplier','FrontEndController@messageToSupplier');
        Route::post('/supplier-list-ajax','FrontEndController@supplierListAjax');
        Route::get('/message-to-supplier','FrontEndController@messageToSupplier');


        Route::get('/cns-image-edit','SystemSettingsController@cnsImageView');
        Route::post('/cns-image','SystemSettingsController@cnsImageUpdate');

        Route::get('/cst-forwarding/pending','CstForwardingController@pendingIndex');
        Route::get('/cst-forwarding/pending-create/{tenderId}/{tenderNumber}','CstForwardingController@pendingCreate');
        Route::post('/cst-forwarding/pending-store','CstForwardingController@pendingStore');

        Route::get('/cst-forwarding/waiting-for-approved','CstForwardingController@waitingForApprovedIndex');

        Route::get('/cst-forwarding/approved','CstForwardingController@approvedIndex');
	    Route::get('/cst-forwarding/approve-create/{id}','CstForwardingController@ApprovedCreate');
	    Route::post('/cst-forwarding/approve-store','CstForwardingController@ApprovedStore');

	    Route::get('/cst-forwarding/print/{id}','CstForwardingController@print');

	    Route::get('/bill/pending','BillController@pendingIndex');
	    Route::get('/bill/pending-create/{tenderId}/{tenderNumber}/{poId}/{crId}/{inspectionId}','BillController@pendingCreate');
	    Route::post('/bill/pending-store','BillController@pendingStore');

	    Route::get('/bill/waiting-for-approved','BillController@waitingForApprovedIndex');
	    Route::get('/bill/approved','BillController@approvedIndex');
	    Route::get('/bill/approve-create/{id}','BillController@ApprovedCreate');
	    Route::post('/bill/approve-store','BillController@ApprovedStore');
